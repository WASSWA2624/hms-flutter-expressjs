...
- Stock-alert desks intentionally reuse Catalog → Inventory filtered views (`applyDeskStockFilter`); dedicated alert tables are not required while Inventory chrome meets tabs/tables/print rules (`09`–`12`).
