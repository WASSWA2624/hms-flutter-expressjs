...
Follow [`00-global-implementation-standards.md`](./00-global-implementation-standards.md).
It is mandatory; this prompt only adds authentication-specific requirements and
the documented full-page exception for unauthenticated auth screens.
