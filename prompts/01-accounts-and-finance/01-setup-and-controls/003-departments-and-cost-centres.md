# Prompt 003 — Implement Departments & Cost Centres

## Context

- **Sequence:** 003 of 159
- **Phase:** Accounts foundation — setup and controls
- **Prerequisite:** Prompt 002 — Currencies & Exchange Rates (`prompts/01-finance-tabs/01-accounts-and-finance/01-setup-and-controls/002-currencies-and-exchange-rates.md`).
...
- **AC1 (R1):** `/accounts?section=departments-and-cost-centres` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/setup-and-controls/departments-and-cost-centres.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/departments_and_cost_centres_tab.dart`
