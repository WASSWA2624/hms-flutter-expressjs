# Prompt 007 — Implement Approval Rules

## Context

- **Sequence:** 007 of 159
- **Phase:** Accounts foundation — setup and controls
- **Prerequisite:** Prompt 006 — Posting Rules (`prompts/01-finance-tabs/01-accounts-and-finance/01-setup-and-controls/006-posting-rules.md`).
...
- **AC1 (R1):** `/accounts?section=approval-rules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/setup-and-controls/approval-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/approval_rules_tab.dart`
