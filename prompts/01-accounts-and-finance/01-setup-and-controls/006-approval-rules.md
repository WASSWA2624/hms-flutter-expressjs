...
- **Prerequisite:** Prompt 005 — Posting Rules (`prompts/01-accounts-and-finance/01-setup-and-controls/005-posting-rules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 007 until all acceptance criteria below pass.
