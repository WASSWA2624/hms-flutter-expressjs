...
- **Prerequisite:** Prompt 003 — Payment Methods (`prompts/01-accounts-and-finance/01-setup-and-controls/003-payment-methods.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 005 until all acceptance criteria below pass.
