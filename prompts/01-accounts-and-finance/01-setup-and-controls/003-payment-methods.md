# Prompt 003 — Implement Payment Methods
...
- **AC2 (R2):** `/accounts?section=payment-methods` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC3 (R3):** All API operations in `.cursor/finance/accounts-and-finance/setup-and-controls/payment-methods.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/accounts_payment_methods_panel.dart`
