# Prompt 002 — Implement Departments & Cost Centres

## Context

- **Sequence:** 002 of 008 in `prompts/01-accounts-and-finance/01-setup-and-controls/`
- **Overall step:** 002 of 158
- **Phase:** Accounts foundation — setup and controls
- **Prerequisite:** `Accounts & Finance → Setup & Controls → Fiscal Years & Periods` (`prompts/01-accounts-and-finance/01-setup-and-controls/001-fiscal-years-and-periods.md`).
- **Menu path:** `Accounts & Finance → Setup & Controls → Departments & Cost Centres`
- **Canonical route:** `/accounts?section=departments-and-cost-centres`
...
- **Authoritative tab specification:** `.cursor/finance/accounts-and-finance/setup-and-controls/departments-and-cost-centres.md`
...
2. **Register and scope the menu item.**
   - Implement the `Departments & Cost Centres` leaf menu item at `Accounts & Finance → Setup & Controls → Departments & Cost Centres` with canonical section slug `departments-and-cost-centres`.
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Accounts & Finance → Setup & Controls → Payment Methods` (`prompts/01-accounts-and-finance/01-setup-and-controls/003-payment-methods.md`) until all acceptance criteria below pass.
...
- **AC2 (R2):** `/accounts?section=departments-and-cost-centres` opens the correct authorized menu item, restores state, and omits it when access is denied.
- **AC3 (R3):** All API operations in `.cursor/finance/accounts-and-finance/setup-and-controls/departments-and-cost-centres.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/accounts_departments_and_cost_centres_panel.dart`
