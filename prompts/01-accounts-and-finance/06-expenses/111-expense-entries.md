# Prompt 111 — Implement Expense Entries

## Context

- **Sequence:** 111 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 110 — AP Reconciliation (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/110-ap-reconciliation.md`).
...
- **AC1 (R1):** `/accounts?section=expense-entries` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/expense-entries.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/expense_entries_tab.dart`
