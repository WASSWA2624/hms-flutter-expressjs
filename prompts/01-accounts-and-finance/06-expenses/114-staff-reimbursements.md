# Prompt 114 — Implement Staff Reimbursements

## Context

- **Sequence:** 114 of 158
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 113 — Recurring Expenses (`prompts/01-accounts-and-finance/06-expenses/113-recurring-expenses.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 115 until all acceptance criteria below pass.
