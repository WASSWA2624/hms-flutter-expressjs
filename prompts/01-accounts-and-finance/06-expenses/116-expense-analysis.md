# Prompt 116 — Implement Expense Analysis

## Context

- **Sequence:** 116 of 158
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 115 — Expense Categories (`prompts/01-accounts-and-finance/06-expenses/115-expense-categories.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 117 until all acceptance criteria below pass.
