# Prompt 110 — Implement Expense Entries

## Context

- **Sequence:** 110 of 158
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 109 — AP Reconciliation (`prompts/01-accounts-and-finance/05-purchases-and-payables/109-ap-reconciliation.md`).
