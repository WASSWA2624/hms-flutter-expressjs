# Prompt 111 — Implement Expense Requests

## Context

- **Sequence:** 111 of 158
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 110 — Expense Entries (`prompts/01-accounts-and-finance/06-expenses/110-expense-entries.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 112 until all acceptance criteria below pass.
