# Prompt 113 — Implement Expense Approvals

## Context

- **Sequence:** 113 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 112 — Expense Requests (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/112-expense-requests.md`).
...
- **AC1 (R1):** `/accounts?section=expense-approvals` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/expense-approvals.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/expense_approvals_tab.dart`
