# Prompt 113 — Implement Recurring Expenses

## Context

- **Sequence:** 113 of 158
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 112 — Expense Approvals (`prompts/01-accounts-and-finance/06-expenses/112-expense-approvals.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 114 until all acceptance criteria below pass.
