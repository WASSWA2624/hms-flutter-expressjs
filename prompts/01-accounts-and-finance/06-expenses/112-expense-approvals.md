# Prompt 112 — Implement Expense Approvals

## Context

- **Sequence:** 112 of 158
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 111 — Expense Requests (`prompts/01-accounts-and-finance/06-expenses/111-expense-requests.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 113 until all acceptance criteria below pass.
