# Prompt 133 — Implement Tax Codes & Rates

## Context

- **Sequence:** 133 of 159
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 132 — Variance Analysis (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/132-variance-analysis.md`).
...
- **AC1 (R1):** `/accounts?section=tax-codes-and-rates` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/tax-and-compliance/tax-codes-and-rates.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/tax_codes_and_rates_tab.dart`
