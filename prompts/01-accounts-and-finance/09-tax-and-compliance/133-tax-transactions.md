# Prompt 133 — Implement Tax Transactions

## Context

- **Sequence:** 133 of 158
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 132 — Tax Codes & Rates (`prompts/01-accounts-and-finance/09-tax-and-compliance/132-tax-codes-and-rates.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 134 until all acceptance criteria below pass.
