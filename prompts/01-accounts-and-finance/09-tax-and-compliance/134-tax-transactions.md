# Prompt 134 — Implement Tax Transactions

## Context

- **Sequence:** 134 of 159
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 133 — Tax Codes & Rates (`prompts/01-finance-tabs/01-accounts-and-finance/09-tax-and-compliance/133-tax-codes-and-rates.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 135 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=tax-transactions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/tax-and-compliance/tax-transactions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/tax_transactions_tab.dart`
