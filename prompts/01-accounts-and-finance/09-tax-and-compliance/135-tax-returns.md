# Prompt 135 — Implement Tax Returns

## Context

- **Sequence:** 135 of 158
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 134 — Withholding Tax (`prompts/01-accounts-and-finance/09-tax-and-compliance/134-withholding-tax.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 136 until all acceptance criteria below pass.
