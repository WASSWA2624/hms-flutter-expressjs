# Prompt 137 — Implement Regulatory Reports

## Context

- **Sequence:** 137 of 159
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 136 — Tax Returns (`prompts/01-finance-tabs/01-accounts-and-finance/09-tax-and-compliance/136-tax-returns.md`).
...
- **AC1 (R1):** `/accounts?section=regulatory-reports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/tax-and-compliance/regulatory-reports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/regulatory_reports_tab.dart`
