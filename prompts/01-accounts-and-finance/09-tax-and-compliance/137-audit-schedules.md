# Prompt 137 — Implement Audit Schedules

## Context

- **Sequence:** 137 of 158
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 136 — Regulatory Reports (`prompts/01-accounts-and-finance/09-tax-and-compliance/136-regulatory-reports.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 138 until all acceptance criteria below pass.
