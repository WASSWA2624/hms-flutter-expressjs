# Prompt 132 — Implement Tax Codes & Rates

## Context

- **Sequence:** 132 of 158
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 131 — Variance Analysis (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/131-variance-analysis.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 133 until all acceptance criteria below pass.
