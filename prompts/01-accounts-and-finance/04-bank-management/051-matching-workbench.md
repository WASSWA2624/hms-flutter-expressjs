# Prompt 051 — Implement Matching Workbench

## Context

- **Sequence:** 051 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 050 — Statement Imports (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/050-statement-imports.md`).
...
- **AC1 (R1):** `/accounts?section=matching-workbench` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/matching-workbench.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/matching_workbench_tab.dart`
