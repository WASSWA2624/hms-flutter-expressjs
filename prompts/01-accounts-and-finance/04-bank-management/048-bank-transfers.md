# Prompt 048 — Implement Bank Transfers

## Context

- **Sequence:** 048 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 047 — Withdrawals & Charges (`prompts/01-accounts-and-finance/04-bank-management/047-withdrawals-and-charges.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 049 until all acceptance criteria below pass.
