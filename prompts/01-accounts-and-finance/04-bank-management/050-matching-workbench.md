# Prompt 050 — Implement Matching Workbench

## Context

- **Sequence:** 050 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 049 — Statement Imports (`prompts/01-accounts-and-finance/04-bank-management/049-statement-imports.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 051 until all acceptance criteria below pass.
