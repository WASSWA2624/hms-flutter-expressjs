# Prompt 046 — Implement Bank Deposits

## Context

- **Sequence:** 046 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 045 — Bank Transactions (`prompts/01-accounts-and-finance/04-bank-management/045-bank-transactions.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 047 until all acceptance criteria below pass.
