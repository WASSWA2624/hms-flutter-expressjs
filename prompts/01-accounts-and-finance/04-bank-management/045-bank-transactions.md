# Prompt 045 — Implement Bank Transactions

## Context

- **Sequence:** 045 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 044 — Bank Accounts (`prompts/01-accounts-and-finance/04-bank-management/044-bank-accounts.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 046 until all acceptance criteria below pass.
