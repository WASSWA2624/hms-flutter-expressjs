# Prompt 049 — Implement Bank Transfers

## Context

- **Sequence:** 049 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 048 — Withdrawals & Charges (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/048-withdrawals-and-charges.md`).
...
- **AC1 (R1):** `/accounts?section=bank-transfers` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/bank-transfers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/bank_transfers_tab.dart`
