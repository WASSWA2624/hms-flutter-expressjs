# Prompt 047 — Implement Withdrawals & Charges

## Context

- **Sequence:** 047 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 046 — Bank Deposits (`prompts/01-accounts-and-finance/04-bank-management/046-bank-deposits.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 048 until all acceptance criteria below pass.
