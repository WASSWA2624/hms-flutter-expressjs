# Prompt 051 — Implement Bank Reconciliations

## Context

- **Sequence:** 051 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 050 — Matching Workbench (`prompts/01-accounts-and-finance/04-bank-management/050-matching-workbench.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 052 until all acceptance criteria below pass.
