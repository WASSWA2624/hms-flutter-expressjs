# Prompt 046 — Implement Bank Transactions

## Context

- **Sequence:** 046 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 045 — Bank Accounts (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/045-bank-accounts.md`).
...
- **AC1 (R1):** `/accounts?section=bank-transactions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/bank-transactions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/bank_transactions_tab.dart`
