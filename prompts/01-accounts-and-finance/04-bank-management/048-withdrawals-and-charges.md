# Prompt 048 — Implement Withdrawals & Charges

## Context

- **Sequence:** 048 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 047 — Bank Deposits (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/047-bank-deposits.md`).
...
- **AC1 (R1):** `/accounts?section=withdrawals-and-charges` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/withdrawals-and-charges.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/withdrawals_and_charges_tab.dart`
