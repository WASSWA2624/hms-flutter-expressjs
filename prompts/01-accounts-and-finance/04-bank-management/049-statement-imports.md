# Prompt 049 — Implement Statement Imports

## Context

- **Sequence:** 049 of 158
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 048 — Bank Transfers (`prompts/01-accounts-and-finance/04-bank-management/048-bank-transfers.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 050 until all acceptance criteria below pass.
