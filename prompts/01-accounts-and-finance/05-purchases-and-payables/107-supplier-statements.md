# Prompt 107 — Implement Supplier Statements

## Context

- **Sequence:** 107 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 106 — Supplier Payments (`prompts/01-accounts-and-finance/05-purchases-and-payables/106-supplier-payments.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 108 until all acceptance criteria below pass.
