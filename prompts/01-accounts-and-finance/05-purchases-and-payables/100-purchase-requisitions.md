# Prompt 100 — Implement Purchase Requisitions

## Context

- **Sequence:** 100 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 099 — Suppliers (`prompts/01-accounts-and-finance/05-purchases-and-payables/099-suppliers.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 101 until all acceptance criteria below pass.
