# Prompt 106 — Implement Supplier Payments

## Context

- **Sequence:** 106 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 105 — Payment Runs (`prompts/01-accounts-and-finance/05-purchases-and-payables/105-payment-runs.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 107 until all acceptance criteria below pass.
