# Prompt 103 — Implement Goods Received Notes

## Context

- **Sequence:** 103 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 102 — Purchase Orders (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/102-purchase-orders.md`).
...
- **AC1 (R1):** `/accounts?section=goods-received-notes` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/goods-received-notes.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/goods_received_notes_tab.dart`
