# Prompt 105 — Implement Supplier Adjustments

## Context

- **Sequence:** 105 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 104 — Supplier Invoices (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/104-supplier-invoices.md`).
...
- **AC1 (R1):** `/accounts?section=supplier-adjustments` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-adjustments.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/supplier_adjustments_tab.dart`
