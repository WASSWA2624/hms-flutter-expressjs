# Prompt 102 — Implement Purchase Orders

## Context

- **Sequence:** 102 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 101 — Purchase Requisitions (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/101-purchase-requisitions.md`).
...
- **AC1 (R1):** `/accounts?section=purchase-orders` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/purchase-orders.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/purchase_orders_tab.dart`
