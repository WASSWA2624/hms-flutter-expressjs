# Prompt 109 — Implement AP Aging

## Context

- **Sequence:** 109 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 108 — Supplier Statements (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/108-supplier-statements.md`).
...
- **AC1 (R1):** `/accounts?section=ap-aging` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/ap-aging.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/ap_aging_tab.dart`
