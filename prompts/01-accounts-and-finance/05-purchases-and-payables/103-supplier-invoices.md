# Prompt 103 — Implement Supplier Invoices

## Context

- **Sequence:** 103 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 102 — Goods Received Notes (`prompts/01-accounts-and-finance/05-purchases-and-payables/102-goods-received-notes.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 104 until all acceptance criteria below pass.
