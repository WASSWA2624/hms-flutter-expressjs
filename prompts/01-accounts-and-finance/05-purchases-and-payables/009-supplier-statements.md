# Prompt 009 — Implement Supplier Statements

## Context

- **Sequence:** 009 of 011 in `prompts/01-accounts-and-finance/05-purchases-and-payables/`
- **Overall step:** 048 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** `Accounts & Finance → Purchases & Payables → Supplier Payments` (`prompts/01-accounts-and-finance/05-purchases-and-payables/008-supplier-payments.md`).
- **Menu path:** `Accounts & Finance → Purchases & Payables → Supplier Statements`
- **Canonical route:** `/accounts?section=supplier-statements`
...
- **Authoritative tab specification:** `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-statements.md`
...
2. **Register and scope the tab.**
   - Implement the `Supplier Statements` tab at `Accounts & Finance → Purchases & Payables → Supplier Statements` with canonical section slug `supplier-statements`.
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-statements.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-statements.md`:
     `Transaction Date`, `Supplier`, `Document Type`, `Document Reference`, `Description`, `Due Date`, `Debit`, `Credit`, `Running Balance`, `Currency`, `Matching Reference`, `Posting Status`.
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Accounts & Finance → Purchases & Payables → AP Aging` (`prompts/01-accounts-and-finance/05-purchases-and-payables/010-ap-aging.md`) until all acceptance criteria below pass.
...
- **AC2 (R2):** `/accounts?section=supplier-statements` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC3 (R3):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-statements.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-statements.md`
...
- `frontend/lib/features/accounts/presentation/widgets/accounts_supplier_statements_panel.dart`
