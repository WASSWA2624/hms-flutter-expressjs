# Prompt 108 — Implement AP Aging

## Context

- **Sequence:** 108 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 107 — Supplier Statements (`prompts/01-accounts-and-finance/05-purchases-and-payables/107-supplier-statements.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 109 until all acceptance criteria below pass.
