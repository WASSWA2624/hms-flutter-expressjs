# Prompt 105 — Implement Payment Runs

## Context

- **Sequence:** 105 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 104 — Supplier Adjustments (`prompts/01-accounts-and-finance/05-purchases-and-payables/104-supplier-adjustments.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 106 until all acceptance criteria below pass.
