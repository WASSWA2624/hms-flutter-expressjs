# Prompt 102 — Implement Goods Received Notes

## Context

- **Sequence:** 102 of 158
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 101 — Purchase Orders (`prompts/01-accounts-and-finance/05-purchases-and-payables/101-purchase-orders.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 103 until all acceptance criteria below pass.
