# Prompt 147 — Implement Balance Sheet

## Context

- **Sequence:** 147 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 146 — Income Statement (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/146-income-statement.md`).
...
- **AC1 (R1):** `/accounts?section=balance-sheet` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/balance-sheet.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/balance_sheet_tab.dart`
