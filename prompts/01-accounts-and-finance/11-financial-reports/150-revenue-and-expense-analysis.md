# Prompt 150 — Implement Revenue & Expense Analysis

## Context

- **Sequence:** 150 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 149 — General Ledger Report (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/149-general-ledger-report.md`).
...
- **Tab profile:** `report` table/worklist
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 151 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=revenue-and-expense-analysis` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/revenue-and-expense-analysis.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/revenue_and_expense_analysis_tab.dart`
