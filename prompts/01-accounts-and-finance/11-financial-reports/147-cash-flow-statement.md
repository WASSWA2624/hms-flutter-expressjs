# Prompt 147 — Implement Cash Flow Statement

## Context

- **Sequence:** 147 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 146 — Balance Sheet (`prompts/01-accounts-and-finance/11-financial-reports/146-balance-sheet.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 148 until all acceptance criteria below pass.
