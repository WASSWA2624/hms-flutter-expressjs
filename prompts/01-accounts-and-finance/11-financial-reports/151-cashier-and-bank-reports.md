# Prompt 151 — Implement Cashier & Bank Reports

## Context

- **Sequence:** 151 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 150 — Department Performance (`prompts/01-accounts-and-finance/11-financial-reports/150-department-performance.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 152 until all acceptance criteria below pass.
