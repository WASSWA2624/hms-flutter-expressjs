# Prompt 148 — Implement General Ledger Report

## Context

- **Sequence:** 148 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 147 — Cash Flow Statement (`prompts/01-accounts-and-finance/11-financial-reports/147-cash-flow-statement.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 149 until all acceptance criteria below pass.
