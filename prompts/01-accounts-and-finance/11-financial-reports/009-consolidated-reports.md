# Prompt 009 — Implement Consolidated Reports

## Context

- **Sequence:** 009 of 009 in `prompts/01-accounts-and-finance/11-financial-reports/`
- **Overall step:** 093 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** `Accounts & Finance → Financial Reports → Cashier & Bank Reports` (`prompts/01-accounts-and-finance/11-financial-reports/008-cashier-and-bank-reports.md`).
- **Menu path:** `Accounts & Finance → Financial Reports → Consolidated Reports`
- **Canonical route:** `/accounts?section=consolidated-reports`
...
- **Authoritative tab specification:** `.cursor/finance/accounts-and-finance/financial-reports/consolidated-reports.md`
...
2. **Register and scope the tab.**
   - Implement the `Consolidated Reports` tab at `Accounts & Finance → Financial Reports → Consolidated Reports` with canonical section slug `consolidated-reports`.
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/accounts-and-finance/financial-reports/consolidated-reports.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/accounts-and-finance/financial-reports/consolidated-reports.md`:
     `Reporting Period`, `Entity/Facility`, `Consolidation Group`, `Local Currency`, `Reporting Currency`, `Exchange Rate`, `Revenue`, `Expenses`, `Assets`, `Liabilities`, `Equity`, `Eliminations`, `Consolidated Amount`, `Validation Difference`, `Consolidation Status`.
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Accounts & Finance → Audit Trail → Transaction History` (`prompts/01-accounts-and-finance/12-audit-trail/001-transaction-history.md`) until all acceptance criteria below pass.
...
- **AC2 (R2):** `/accounts?section=consolidated-reports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC3 (R3):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/consolidated-reports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/accounts-and-finance/financial-reports/consolidated-reports.md`
...
- `frontend/lib/features/accounts/presentation/widgets/accounts_consolidated_reports_panel.dart`
