# Prompt 146 — Implement Income Statement

## Context

- **Sequence:** 146 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 145 — Trial Balance (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/145-trial-balance.md`).
...
- **AC1 (R1):** `/accounts?section=income-statement` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/income-statement.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/income_statement_tab.dart`
