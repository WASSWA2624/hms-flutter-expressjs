# Prompt 146 — Implement Balance Sheet

## Context

- **Sequence:** 146 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 145 — Income Statement (`prompts/01-accounts-and-finance/11-financial-reports/145-income-statement.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 147 until all acceptance criteria below pass.
