# Prompt 151 — Implement Department Performance

## Context

- **Sequence:** 151 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 150 — Revenue & Expense Analysis (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/150-revenue-and-expense-analysis.md`).
...
- **AC1 (R1):** `/accounts?section=department-performance` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/department-performance.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/department_performance_tab.dart`
