# Prompt 152 — Implement Consolidated Reports

## Context

- **Sequence:** 152 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 151 — Cashier & Bank Reports (`prompts/01-accounts-and-finance/11-financial-reports/151-cashier-and-bank-reports.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 153 until all acceptance criteria below pass.
