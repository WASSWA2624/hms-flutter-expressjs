# Prompt 145 — Implement Trial Balance

## Context

- **Sequence:** 145 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 144 — Year-end Close Runs (`prompts/01-finance-tabs/01-accounts-and-finance/10-period-close/144-year-end-close-runs.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 146 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=trial-balance` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/trial-balance.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/trial_balance_tab.dart`
