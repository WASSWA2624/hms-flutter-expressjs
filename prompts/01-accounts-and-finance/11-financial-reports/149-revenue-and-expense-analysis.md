# Prompt 149 — Implement Revenue & Expense Analysis

## Context

- **Sequence:** 149 of 158
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 148 — General Ledger Report (`prompts/01-accounts-and-finance/11-financial-reports/148-general-ledger-report.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 150 until all acceptance criteria below pass.
