# Prompt 040 — Implement Cash Transfers

## Context

- **Sequence:** 040 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 039 — Cash Transactions (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/039-cash-transactions.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 041 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=cash-transfers` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cash-transfers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_transfers_tab.dart`
