# Prompt 043 — Implement Cash Reconciliation

## Context

- **Sequence:** 043 of 158
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 042 — Cash Variances (`prompts/01-accounts-and-finance/03-cash-management/042-cash-variances.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 044 until all acceptance criteria below pass.
