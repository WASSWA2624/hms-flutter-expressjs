# Prompt 042 — Implement Cash Variances

## Context

- **Sequence:** 042 of 158
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 041 — Session Closures (`prompts/01-accounts-and-finance/03-cash-management/041-session-closures.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 043 until all acceptance criteria below pass.
