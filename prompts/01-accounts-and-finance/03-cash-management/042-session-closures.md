# Prompt 042 — Implement Session Closures

## Context

- **Sequence:** 042 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 041 — Cash Counts (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/041-cash-counts.md`).
...
- **AC1 (R1):** `/accounts?section=session-closures` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/session-closures.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/session_closures_tab.dart`
