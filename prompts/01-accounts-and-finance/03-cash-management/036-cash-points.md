# Prompt 036 — Implement Cash Points

## Context

- **Sequence:** 036 of 158
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 035 — Debit Notes (`prompts/02-billing/035-debit-notes.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 037 until all acceptance criteria below pass.
