# Prompt 037 — Implement Cashier Sessions

## Context

- **Sequence:** 037 of 158
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 036 — Cash Points (`prompts/01-accounts-and-finance/03-cash-management/036-cash-points.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 038 until all acceptance criteria below pass.
