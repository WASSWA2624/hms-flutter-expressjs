# Prompt 003 — Implement Cash Transactions

## Context

- **Sequence:** 003 of 008 in `prompts/01-accounts-and-finance/03-cash-management/`
- **Overall step:** 026 of 158
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** `Accounts & Finance → Cash Management → Cashier Sessions` (`prompts/01-accounts-and-finance/03-cash-management/002-cashier-sessions.md`).
- **Menu path:** `Accounts & Finance → Cash Management → Cash Transactions`
- **Canonical route:** `/accounts?section=cash-transactions`
...
- **Authoritative tab specification:** `.cursor/finance/accounts-and-finance/cash-management/cash-transactions.md`
...
2. **Register and scope the tab.**
   - Implement the `Cash Transactions` tab at `Accounts & Finance → Cash Management → Cash Transactions` with canonical section slug `cash-transactions`.
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/accounts-and-finance/cash-management/cash-transactions.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/accounts-and-finance/cash-management/cash-transactions.md`:
     `Transaction No.`, `Date/Time`, `Session No.`, `Cash Point`, `Cashier`, `Transaction Type`, `Source Module`, `Source Document`, `Patient/Payee`, `Description`, `Cash In`, `Cash Out`, `Running Balance`, `Currency`, `Receipt/Payment No.`, `Transaction Status`.
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Accounts & Finance → Cash Management → Cash Transfers` (`prompts/01-accounts-and-finance/03-cash-management/004-cash-transfers.md`) until all acceptance criteria below pass.
...
- **AC2 (R2):** `/accounts?section=cash-transactions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC3 (R3):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cash-transactions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/accounts-and-finance/cash-management/cash-transactions.md`
...
- `frontend/lib/features/accounts/presentation/widgets/accounts_cash_transactions_panel.dart`
