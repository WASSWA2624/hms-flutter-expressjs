# Prompt 043 — Implement Cash Variances

## Context

- **Sequence:** 043 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 042 — Session Closures (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/042-session-closures.md`).
...
- **AC1 (R1):** `/accounts?section=cash-variances` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cash-variances.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_variances_tab.dart`
