# Prompt 039 — Implement Cash Transactions

## Context

- **Sequence:** 039 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 038 — Cashier Sessions (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/038-cashier-sessions.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 040 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=cash-transactions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cash-transactions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_transactions_tab.dart`
