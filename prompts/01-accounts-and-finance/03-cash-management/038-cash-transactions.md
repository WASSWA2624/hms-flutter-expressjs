# Prompt 038 — Implement Cash Transactions

## Context

- **Sequence:** 038 of 158
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 037 — Cashier Sessions (`prompts/01-accounts-and-finance/03-cash-management/037-cashier-sessions.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 039 until all acceptance criteria below pass.
