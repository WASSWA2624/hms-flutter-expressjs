# Prompt 130 — Implement Budget vs Actual

## Context

- **Sequence:** 130 of 158
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 129 — Commitments (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/129-commitments.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 131 until all acceptance criteria below pass.
