# Prompt 128 — Implement Budget Revisions

## Context

- **Sequence:** 128 of 158
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 127 — Project Budgets (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/127-project-budgets.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 129 until all acceptance criteria below pass.
