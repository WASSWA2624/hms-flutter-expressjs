# Prompt 131 — Implement Variance Analysis

## Context

- **Sequence:** 131 of 158
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 130 — Budget vs Actual (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/130-budget-vs-actual.md`).
