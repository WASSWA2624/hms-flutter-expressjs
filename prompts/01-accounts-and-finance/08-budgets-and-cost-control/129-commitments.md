# Prompt 129 — Implement Commitments

## Context

- **Sequence:** 129 of 158
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 128 — Budget Revisions (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/128-budget-revisions.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 130 until all acceptance criteria below pass.
