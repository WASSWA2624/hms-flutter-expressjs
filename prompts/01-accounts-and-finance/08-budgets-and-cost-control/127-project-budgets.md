# Prompt 127 — Implement Project Budgets

## Context

- **Sequence:** 127 of 158
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 126 — Department Budgets (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/126-department-budgets.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 128 until all acceptance criteria below pass.
