# Prompt 132 — Implement Variance Analysis

## Context

- **Sequence:** 132 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 131 — Budget vs Actual (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/131-budget-vs-actual.md`).
...
- **AC1 (R1):** `/accounts?section=variance-analysis` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/variance-analysis.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/variance_analysis_tab.dart`
