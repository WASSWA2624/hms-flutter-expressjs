# Prompt 126 — Implement Department Budgets

## Context

- **Sequence:** 126 of 158
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 125 — Annual Budgets (`prompts/01-accounts-and-finance/08-budgets-and-cost-control/125-annual-budgets.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 127 until all acceptance criteria below pass.
