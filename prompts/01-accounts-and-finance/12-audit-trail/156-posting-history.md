# Prompt 156 — Implement Posting History

## Context

- **Sequence:** 156 of 159
- **Phase:** Accounts operations — audit trail
- **Prerequisite:** Prompt 155 — Approval History (`prompts/01-finance-tabs/01-accounts-and-finance/12-audit-trail/155-approval-history.md`).
...
- **AC1 (R1):** `/accounts?section=posting-history` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/audit-trail/posting-history.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/posting_history_tab.dart`
