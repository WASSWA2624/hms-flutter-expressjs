# Prompt 156 — Implement Reversals & Voids

## Context

- **Sequence:** 156 of 158
- **Phase:** Accounts operations — audit trail
- **Prerequisite:** Prompt 155 — Posting History (`prompts/01-accounts-and-finance/12-audit-trail/155-posting-history.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 157 until all acceptance criteria below pass.
