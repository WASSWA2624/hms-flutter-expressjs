# Prompt 143 — Implement Year-end Close Runs

## Context

- **Sequence:** 143 of 158
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 142 — Close History (`prompts/01-accounts-and-finance/10-period-close/142-close-history.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 144 until all acceptance criteria below pass.
