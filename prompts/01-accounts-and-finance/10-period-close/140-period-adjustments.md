# Prompt 140 — Implement Period Adjustments

## Context

- **Sequence:** 140 of 158
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 139 — Reconciliation Checklist (`prompts/01-accounts-and-finance/10-period-close/139-reconciliation-checklist.md`).
