# Prompt 141 — Implement Period Adjustments

## Context

- **Sequence:** 141 of 159
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 140 — Reconciliation Checklist (`prompts/01-finance-tabs/01-accounts-and-finance/10-period-close/140-reconciliation-checklist.md`).
...
- **AC1 (R1):** `/accounts?section=period-adjustments` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/period-close/period-adjustments.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/period_adjustments_tab.dart`
