# Prompt 140 — Implement Reconciliation Checklist

## Context

- **Sequence:** 140 of 159
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 139 — Close Checklist (`prompts/01-finance-tabs/01-accounts-and-finance/10-period-close/139-close-checklist.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 141 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=reconciliation-checklist` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/period-close/reconciliation-checklist.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/reconciliation_checklist_tab.dart`
