# Prompt 139 — Implement Reconciliation Checklist

## Context

- **Sequence:** 139 of 158
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 138 — Close Checklist (`prompts/01-accounts-and-finance/10-period-close/138-close-checklist.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 140 until all acceptance criteria below pass.
