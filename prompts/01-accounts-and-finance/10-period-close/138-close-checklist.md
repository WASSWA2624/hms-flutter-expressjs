# Prompt 138 — Implement Close Checklist

## Context

- **Sequence:** 138 of 158
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 137 — Audit Schedules (`prompts/01-accounts-and-finance/09-tax-and-compliance/137-audit-schedules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 139 until all acceptance criteria below pass.
