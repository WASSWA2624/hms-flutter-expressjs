# Prompt 139 — Implement Close Checklist

## Context

- **Sequence:** 139 of 159
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 138 — Audit Schedules (`prompts/01-finance-tabs/01-accounts-and-finance/09-tax-and-compliance/138-audit-schedules.md`).
...
- **AC1 (R1):** `/accounts?section=close-checklist` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/period-close/close-checklist.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/close_checklist_tab.dart`
