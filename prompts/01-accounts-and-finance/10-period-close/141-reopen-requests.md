# Prompt 141 — Implement Reopen Requests

## Context

- **Sequence:** 141 of 158
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 140 — Period Adjustments (`prompts/01-accounts-and-finance/10-period-close/140-period-adjustments.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 142 until all acceptance criteria below pass.
