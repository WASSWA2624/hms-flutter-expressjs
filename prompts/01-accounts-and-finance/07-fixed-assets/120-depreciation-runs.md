# Prompt 120 — Implement Depreciation Runs

## Context

- **Sequence:** 120 of 158
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 119 — Asset Acquisitions (`prompts/01-accounts-and-finance/07-fixed-assets/119-asset-acquisitions.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 121 until all acceptance criteria below pass.
