# Prompt 119 — Implement Asset Acquisitions

## Context

- **Sequence:** 119 of 158
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 118 — Asset Categories (`prompts/01-accounts-and-finance/07-fixed-assets/118-asset-categories.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 120 until all acceptance criteria below pass.
