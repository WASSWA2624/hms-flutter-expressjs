# Prompt 124 — Implement Asset Ledger

## Context

- **Sequence:** 124 of 158
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 123 — Disposals (`prompts/01-accounts-and-finance/07-fixed-assets/123-disposals.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 125 until all acceptance criteria below pass.
