# Prompt 118 — Implement Asset Register

## Context

- **Sequence:** 118 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 117 — Expense Analysis (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/117-expense-analysis.md`).
...
- **AC1 (R1):** `/accounts?section=asset-register` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/asset-register.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/asset_register_tab.dart`
