# Prompt 121 — Implement Asset Transfers

## Context

- **Sequence:** 121 of 158
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 120 — Depreciation Runs (`prompts/01-accounts-and-finance/07-fixed-assets/120-depreciation-runs.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 122 until all acceptance criteria below pass.
