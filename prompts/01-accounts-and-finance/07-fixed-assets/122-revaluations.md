# Prompt 122 — Implement Revaluations

## Context

- **Sequence:** 122 of 158
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 121 — Asset Transfers (`prompts/01-accounts-and-finance/07-fixed-assets/121-asset-transfers.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 123 until all acceptance criteria below pass.
