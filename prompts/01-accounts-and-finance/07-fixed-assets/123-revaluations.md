# Prompt 123 — Implement Revaluations

## Context

- **Sequence:** 123 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 122 — Asset Transfers (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/122-asset-transfers.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 124 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=revaluations` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/revaluations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/revaluations_tab.dart`
