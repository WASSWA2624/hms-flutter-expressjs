# Prompt 118 — Implement Asset Categories

## Context

- **Sequence:** 118 of 158
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 117 — Asset Register (`prompts/01-accounts-and-finance/07-fixed-assets/117-asset-register.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 119 until all acceptance criteria below pass.
