# Prompt 021 — Implement Control Accounts

## Context

- **Sequence:** 021 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 020 — General Ledger (`prompts/01-accounts-and-finance/02-general-accounting/020-general-ledger.md`).
