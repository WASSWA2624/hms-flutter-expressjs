# Prompt 023 — Implement Recurring Entries

## Context

- **Sequence:** 023 of 159
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 022 — Control Accounts (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/022-control-accounts.md`).
...
- **AC1 (R1):** `/accounts?section=recurring-entries` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/recurring-entries.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/recurring_entries_tab.dart`
