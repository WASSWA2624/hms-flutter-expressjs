# Prompt 012 — Implement General Ledger

## Context

- **Sequence:** 012 of 015 in `prompts/01-accounts-and-finance/02-general-accounting/`
- **Overall step:** 020 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** `Accounts & Finance → General Accounting → Journal Entries → Asset Journal` (`prompts/01-accounts-and-finance/02-general-accounting/011-asset-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Accounts & Finance → General Accounting → Control Accounts` (`prompts/01-accounts-and-finance/02-general-accounting/013-control-accounts.md`) until all acceptance criteria below pass.
