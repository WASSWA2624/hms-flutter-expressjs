# Prompt 022 — Implement Recurring Entries

## Context

- **Sequence:** 022 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 021 — Control Accounts (`prompts/01-accounts-and-finance/02-general-accounting/021-control-accounts.md`).
