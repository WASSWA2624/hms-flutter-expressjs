# Prompt 013 — Implement Control Accounts

## Context

- **Sequence:** 013 of 015 in `prompts/01-accounts-and-finance/02-general-accounting/`
- **Overall step:** 021 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** `Accounts & Finance → General Accounting → General Ledger` (`prompts/01-accounts-and-finance/02-general-accounting/012-general-ledger.md`).
...
2. **Register and scope the tab.**
   - Implement the `Control Accounts` tab at `Accounts & Finance → General Accounting → Control Accounts` with canonical section slug `control-accounts`.
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Accounts & Finance → General Accounting → Recurring Entries` (`prompts/01-accounts-and-finance/02-general-accounting/014-recurring-entries.md`) until all acceptance criteria below pass.
...
- **AC2 (R2):** `/accounts?section=control-accounts` opens the correct authorized tab, restores state, and omits it when access is denied.
