# Prompt 020 — Implement General Ledger

## Context

- **Sequence:** 020 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 019 — Asset Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/019-asset-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 021 until all acceptance criteria below pass.
