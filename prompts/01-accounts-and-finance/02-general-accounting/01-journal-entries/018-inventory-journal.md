# Prompt 018 — Implement Inventory Journal

## Context

- **Sequence:** 018 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 017 — Payroll Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/017-payroll-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 019 until all acceptance criteria below pass.
