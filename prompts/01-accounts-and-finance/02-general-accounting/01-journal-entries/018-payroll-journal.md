# Prompt 018 — Implement Payroll Journal

## Context

- **Sequence:** 018 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 017 — Adjustment Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/017-adjustment-journal.md`).
...
- **AC1 (R1):** `/accounts?section=payroll-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/payroll-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/payroll_journal_tab.dart`
