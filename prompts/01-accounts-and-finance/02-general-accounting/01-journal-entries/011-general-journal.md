# Prompt 011 — Implement General Journal

## Context

- **Sequence:** 011 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 010 — All Journal Entries (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/010-all-journal-entries.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 012 until all acceptance criteria below pass.
