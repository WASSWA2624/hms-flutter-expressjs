# Prompt 013 — Implement Purchase Journal

## Context

- **Sequence:** 013 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 012 — Sales Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/012-sales-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 014 until all acceptance criteria below pass.
