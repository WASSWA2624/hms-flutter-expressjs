# Prompt 012 — Implement Sales Journal

## Context

- **Sequence:** 012 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 011 — General Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/011-general-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 013 until all acceptance criteria below pass.
