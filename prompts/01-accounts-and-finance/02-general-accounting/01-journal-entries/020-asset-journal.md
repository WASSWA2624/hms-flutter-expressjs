# Prompt 020 — Implement Asset Journal

## Context

- **Sequence:** 020 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 019 — Inventory Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/019-inventory-journal.md`).
...
- **AC1 (R1):** `/accounts?section=asset-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/asset-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/asset_journal_tab.dart`
