# Prompt 016 — Implement Adjustment Journal

## Context

- **Sequence:** 016 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 015 — Cash Payments Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/015-cash-payments-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 017 until all acceptance criteria below pass.
