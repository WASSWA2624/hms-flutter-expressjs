# Prompt 015 — Implement Cash Payments Journal

## Context

- **Sequence:** 015 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 014 — Cash Receipts Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/014-cash-receipts-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 016 until all acceptance criteria below pass.
