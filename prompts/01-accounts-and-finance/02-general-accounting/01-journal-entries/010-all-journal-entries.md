# Prompt 010 — Implement All Journal Entries

## Context

- **Sequence:** 010 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 009 — Chart of Accounts (`prompts/01-accounts-and-finance/02-general-accounting/009-chart-of-accounts.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 011 until all acceptance criteria below pass.
