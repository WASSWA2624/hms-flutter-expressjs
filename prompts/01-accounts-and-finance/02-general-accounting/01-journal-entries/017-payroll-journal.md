# Prompt 017 — Implement Payroll Journal

## Context

- **Sequence:** 017 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 016 — Adjustment Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/016-adjustment-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 018 until all acceptance criteria below pass.
