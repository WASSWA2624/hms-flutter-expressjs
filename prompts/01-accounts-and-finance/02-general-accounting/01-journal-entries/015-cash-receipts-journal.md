# Prompt 015 — Implement Cash Receipts Journal

## Context

- **Sequence:** 015 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 014 — Purchase Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/014-purchase-journal.md`).
...
- **AC1 (R1):** `/accounts?section=cash-receipts-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/cash-receipts-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_receipts_journal_tab.dart`
