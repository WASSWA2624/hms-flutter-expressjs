# Prompt 014 — Implement Cash Receipts Journal

## Context

- **Sequence:** 014 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 013 — Purchase Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/013-purchase-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 015 until all acceptance criteria below pass.
