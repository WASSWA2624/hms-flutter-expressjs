# Prompt 019 — Implement Asset Journal

## Context

- **Sequence:** 019 of 158
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 018 — Inventory Journal (`prompts/01-accounts-and-finance/02-general-accounting/01-journal-entries/018-inventory-journal.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 020 until all acceptance criteria below pass.
