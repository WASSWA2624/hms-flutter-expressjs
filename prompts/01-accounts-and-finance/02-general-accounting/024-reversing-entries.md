# Prompt 024 — Implement Reversing Entries

## Context

- **Sequence:** 024 of 159
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 023 — Recurring Entries (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/023-recurring-entries.md`).
...
- **AC1 (R1):** `/accounts?section=reversing-entries` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/reversing-entries.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/reversing_entries_tab.dart`
