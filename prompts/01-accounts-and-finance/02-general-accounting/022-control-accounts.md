# Prompt 022 — Implement Control Accounts

## Context

- **Sequence:** 022 of 159
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 021 — General Ledger (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/021-general-ledger.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 023 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=control-accounts` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/control-accounts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/control_accounts_tab.dart`
