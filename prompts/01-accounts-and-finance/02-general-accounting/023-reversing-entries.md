# Prompt 023 — Implement Reversing Entries

## Context

- **Sequence:** 023 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 022 — Recurring Entries (`prompts/01-accounts-and-finance/02-general-accounting/022-recurring-entries.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 024 until all acceptance criteria below pass.
