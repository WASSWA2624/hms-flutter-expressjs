# Prompt 015 — Implement Reversing Entries

## Context

- **Sequence:** 015 of 015 in `prompts/01-accounts-and-finance/02-general-accounting/`
- **Overall step:** 023 of 158
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** `Accounts & Finance → General Accounting → Recurring Entries` (`prompts/01-accounts-and-finance/02-general-accounting/014-recurring-entries.md`).
...
2. **Register and scope the tab.**
   - Implement the `Reversing Entries` tab at `Accounts & Finance → General Accounting → Reversing Entries` with canonical section slug `reversing-entries`.
...
- **AC2 (R2):** `/accounts?section=reversing-entries` opens the correct authorized tab, restores state, and omits it when access is denied.
