# UI Permission Scan — Reception desk / Follow-ups (`/reception?…=follow-ups`)
...
- Target tab: **Follow-ups** (`follow-ups`). Follow-up worklist; complete/reschedule gated by write rights.
...
| View / read UI | any-of (∪) | `patient:read`, `last_office:read` |
