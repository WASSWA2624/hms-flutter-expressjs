# UI Permission Scan — Reception desk / High priority (`/reception?…=high-priority`)
...
- Target tab: **High priority** (`high-priority`). Escalated desk items; emergency handoff may need emergency:read.
...
| Nested cross-module read | any-of (∪) | `emergency:read` |
