# UI Permission Scan — Reception desk / Appointments (`/reception?…=appointments`)
...
- Target tab: **Appointments** (`appointments`). Schedule, check-in, reschedule, cancel appointments.
