# UI Permission Scan — Reception desk / Payment gate (`/reception?…=payment-gate`)
...
- Target tab: **Payment gate** (`payment-gate`). Billing hold / payment clearance before clinical progress.
...
| Create | all-of (∩) | `billing:write` |
| Update | all-of (∩) | `billing:write` |
