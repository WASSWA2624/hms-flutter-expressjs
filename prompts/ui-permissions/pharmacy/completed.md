# UI Permission Scan — Pharmacy workspace / Completed (`/pharmacy?…=completed`)
...
- Target tab: **Completed** (`completed`). Dispensed history; prefer read.
...
| --- | --- | --- |
| View / read UI | all-of (∩) | `pharmacy:read` |
