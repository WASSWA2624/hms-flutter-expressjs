# UI Permission Scan — Billing workspace / Needs issue (`/billing?…=needs-issue`)
...
- Target tab: **Needs issue** (`needs-issue`). Invoices awaiting issue; Issue action needs billing:write.
