# UI Permission Scan — Billing workspace / Awaiting payment (`/billing?…=awaiting-payment`)
...
- Target tab: **Awaiting payment** (`awaiting-payment`). Record payment / receipt actions need billing:write.
