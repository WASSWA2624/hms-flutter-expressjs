# UI Permission Scan — Billing workspace / Claims pending (`/billing?…=claims-pending`)
...
- Screen inventory (read-only; do not modify): `screens/billing.md` (reachable controls).
- Target tab: **Claims pending** (`claims-pending`). Insurance claim handoff; may require billing:read ∩ insurance module.
