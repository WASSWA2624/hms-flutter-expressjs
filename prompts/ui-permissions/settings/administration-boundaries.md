# UI Permission Scan — Settings / Administration boundaries (`/settings?…=administration`)
...
- Target tab: **Administration boundaries** (`administration`). Admin boundaries; admin any-of.
...
| View / read UI | any-of (∪) | `facility:admin`, `tenant:admin`, `system:admin` |
