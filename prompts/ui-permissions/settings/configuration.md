# UI Permission Scan — Settings / Configuration (`/settings?…=configuration`)
...
- Target tab: **Configuration** (`configuration`). Tenant/facility config; admin any-of.
