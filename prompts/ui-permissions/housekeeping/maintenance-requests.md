# UI Permission Scan — Housekeeping workspace / Maintenance requests (`/housekeeping?…=maintenance`)
...
- Screen inventory (read-only; do not modify): `screens/housekeeping.md` (reachable controls).
- Target tab: **Maintenance requests** (`maintenance`). Request maintenance primary.
- Feature code: `frontend/lib/features/housekeeping/`
- Module entitlement: `facilities-maintenance`
- Route entry any-of: `operations:read`, `operations:write`
...
| --- | --- | --- |
| View / read UI | all-of (∩) | `operations:read` |
| View / read UI | any-of (∪) | _(n/a)_ |
| Create | all-of (∩) | `operations:write` |
| Update | all-of (∩) | `operations:write` |
| Delete | all-of (∩) | `operations:write` |
| Nested cross-module read | any-of (∪) | _(n/a)_ |
| Nested cross-module write | any-of (∪) | _(n/a)_ |
| Nested cross-module write | all-of (∩) | _(n/a)_ |

Create task/schedule/maintenance request need operations:write (canManage). Housekeeper role ABAC should prefer assigned/own scope.
