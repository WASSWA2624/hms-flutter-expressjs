# UI Permission Scan — Clinical workspace / In consultation (`/clinical?…=in-consultation`)
...
- Target tab: **In consultation** (`in-consultation`). Active consultation; richest nested action bar.
