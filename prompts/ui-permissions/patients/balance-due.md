# UI Permission Scan — Patients registry / Balance due (`/patients?…=balance-due`)
...
- Target tab: **Balance due** (`balance-due`). Financial filter. Viewing balances requires patient:read ∩ billing:read. Payment/enrollment actions need billing:write where applicable.
...
| --- | --- | --- |
| View / read UI | all-of (∩) | `patient:read`, `billing:read` |
