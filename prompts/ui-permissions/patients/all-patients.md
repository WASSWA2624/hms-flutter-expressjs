# UI Permission Scan — Patients registry / All patients (`/patients?…=all`)
...
- Target tab: **All patients** (`all`). Full registry list; Register patient + Duplicate review on strip.
