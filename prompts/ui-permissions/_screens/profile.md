# UI Permission Scan — Profile / Profile (`/profile?…=profile`)
...
- Screen inventory (read-only; do not modify): `screens/profile.md` (reachable controls).
- Target tab: **Profile** (`profile`). View/edit profile and change password.
