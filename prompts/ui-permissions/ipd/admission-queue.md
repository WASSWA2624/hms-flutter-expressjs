# UI Permission Scan — IPD workspace / Admission Queue (`/ipd?…=admission-queue`)
...
- Target tab: **Admission Queue** (`admission-queue`). Pending admissions; Start admission primary.
