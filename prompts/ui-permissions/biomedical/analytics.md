# UI Permission Scan — Biomedical workspace / Analytics (`/biomedical?…=analytics`)
...
- Screen inventory (read-only; do not modify): `screens/biomedical.md` (reachable controls).
- Target tab: **Analytics** (`analytics`). Charts; reports:read may be required in addition to biomed:read.
- Feature code: `frontend/lib/features/biomedical/`
- Module entitlement: `biomedical-engineering-suite`
- Route entry any-of: `biomed:read`, `biomed:write`
...
| --- | --- | --- |
| View / read UI | all-of (∩) | `biomed:read` |
| View / read UI | any-of (∪) | _(n/a)_ |
| Create | all-of (∩) | `biomed:write` |
| Update | all-of (∩) | `biomed:write` |
| Delete | all-of (∩) | `biomed:write` |
| Nested cross-module read | any-of (∪) | `reports:read` |
| Nested cross-module write | any-of (∪) | _(n/a)_ |
| Nested cross-module write | all-of (∩) | _(n/a)_ |

Register asset / work orders / PM scheduling need biomed:write. Analytics/compliance panels need biomed:read; exports may need reports:read or evidence:export.
