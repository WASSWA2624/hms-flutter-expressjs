# UI Permission Scan — Physiotherapy workspace / Active plans (`/physiotherapy?…=active-plans`)
...
- Screen inventory (read-only; do not modify): `screens/physiotherapy.md` (reachable controls).
- Target tab: **Active plans** (`active-plans`). Active therapy plans.
