# UI Permission Scan — HR workspace / Shifts (`/hr?…=shifts`)
...
- Target tab: **Shifts** (`shifts`). Roster templates/shifts.
...
| Create | all-of (∩) | `roster:write` |
| Update | all-of (∩) | `roster:write` |
| Delete | all-of (∩) | `hr:write` |
| Nested cross-module read | any-of (∪) | _(n/a)_ |
| Nested cross-module write | any-of (∪) | `roster:publish`, `roster:approve` |
