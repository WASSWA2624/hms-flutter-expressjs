# UI Permission Scan — HR workspace / Payroll drafts (`/hr?…=payroll`)
...
- Target tab: **Payroll drafts** (`payroll`). Payroll drafts; approve may need financial:approve.
...
| Create | all-of (∩) | `hr:write` |
| Update | all-of (∩) | `hr:write` |
| Delete | all-of (∩) | `hr:write` |
| Nested cross-module read | any-of (∪) | _(n/a)_ |
| Nested cross-module write | any-of (∪) | `financial:approve`, `hr:write` |
