# UI Permission Scan — Discharge workspace / Completed (`/discharge?…=completed`)
...
- Target tab: **Completed** (`completed`). Completed discharges; prefer read.
...
| View / read UI | any-of (∪) | `clinical:read`, `last_office:read` |
