# UI Permission Scan — Mortuary workspace / Storage (`/mortuary?…=storage`)
...
- Target tab: **Storage** (`storage`). Assign storage; mortuary:manage_storage.
...
| Create | all-of (∩) | `mortuary:manage_storage` |
| Update | all-of (∩) | `mortuary:manage_storage` |
