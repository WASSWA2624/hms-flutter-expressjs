# UI Permission Scan — Mortuary workspace / Custody (`/mortuary?…=custody`)
...
- Target tab: **Custody** (`custody`). Custody chain; post-mortem request / approve gates.
...
| Nested cross-module write | any-of (∪) | `mortuary:post_mortem_request`, `mortuary:approve`, `mortuary:write` |
