# UI Permission Scan — Mortuary workspace / Release (`/mortuary?…=release`)
...
- Target tab: **Release** (`release`). Body release; mortuary:release (often ∩ approve).
...
| Update | all-of (∩) | `mortuary:release` |
