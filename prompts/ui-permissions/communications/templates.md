# UI Permission Scan — Communications workspace / Templates (`/communications?…=templates`)
...
- Screen inventory (read-only; do not modify): `screens/communications.md` (reachable controls).
- Target tab: **Templates** (`templates`). Template CRUD for writers; delete gated.
- Feature code: `frontend/lib/features/communications/`
- Module entitlement: `notifications-communications`
- Route entry any-of: `communications:read`, `communications:write`
...
| --- | --- | --- |
| View / read UI | all-of (∩) | `communications:read` |
| View / read UI | any-of (∪) | _(n/a)_ |
| Create | all-of (∩) | `communications:write` |
| Update | all-of (∩) | `communications:write` |
| Delete | all-of (∩) | `communications:delete` |
| Nested cross-module read | any-of (∪) | _(n/a)_ |
| Nested cross-module write | any-of (∪) | _(n/a)_ |
| Nested cross-module write | all-of (∩) | _(n/a)_ |

New message/group need communications:write. Delete thread/template needs communications:delete. Deliveries are typically read-only operational logs.
