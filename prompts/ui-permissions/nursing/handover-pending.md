# UI Permission Scan — Nursing workspace / Handover pending (`/nursing?…=handover-pending`)
...
- Target tab: **Handover pending** (`handover-pending`). Shift handover complete needs clinical:write.
