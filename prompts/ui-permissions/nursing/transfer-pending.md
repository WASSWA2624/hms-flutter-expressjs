# UI Permission Scan — Nursing workspace / Transfer pending (`/nursing?…=transfer-pending`)
...
- Target tab: **Transfer pending** (`transfer-pending`). Transfer execute needs clinical:write.
