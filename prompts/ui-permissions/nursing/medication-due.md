# UI Permission Scan — Nursing workspace / Medication due (`/nursing?…=medication-due`)
...
- Target tab: **Medication due** (`medication-due`). Due meds; pharmacy:read ∩ clinical:write for charting/admin.
...
| --- | --- | --- |
| View / read UI | all-of (∩) | `clinical:read`, `pharmacy:read` |
