# UI Permission Scan — Subscriptions workspace / Licenses (`/subscriptions?…=licenses`)
...
- Target tab: **Licenses** (`licenses`). Add/revoke licenses; delete needs subscriptions:delete.
