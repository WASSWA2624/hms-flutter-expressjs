# Prompt 053 — Implement Payment Allocations

## Context

- **Sequence:** 053 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 052 — Payments (`prompts/02-billing/052-payments.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 054 until all acceptance criteria below pass.
