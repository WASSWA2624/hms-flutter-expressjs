# Prompt 032 — Implement Estimates & Quotations

## Context

- **Sequence:** 032 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 031 — Unbilled Charges (`prompts/02-billing/031-unbilled-charges.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 033 until all acceptance criteria below pass.
