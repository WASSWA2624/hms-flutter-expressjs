# Prompt 024 — Implement Price Lists & Tariffs

## Context

- **Sequence:** 024 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 023 — Reversing Entries (`prompts/01-accounts-and-finance/02-general-accounting/023-reversing-entries.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 025 until all acceptance criteria below pass.
