# Prompt 035 — Implement Debit Notes

## Context

- **Sequence:** 035 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 034 — Credit Notes (`prompts/02-billing/034-credit-notes.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 036 until all acceptance criteria below pass.
