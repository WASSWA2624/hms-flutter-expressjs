# Prompt 029 — Implement Document Templates

## Context

- **Sequence:** 029 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 028 — Tax Rules (`prompts/02-billing/028-tax-rules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 030 until all acceptance criteria below pass.
