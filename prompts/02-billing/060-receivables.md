# Prompt 060 — Implement Receivables

## Context

- **Sequence:** 060 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 059 — Patient Statements (`prompts/02-billing/059-patient-statements.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 061 until all acceptance criteria below pass.
