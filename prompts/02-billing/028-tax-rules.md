# Prompt 028 — Implement Tax Rules

## Context

- **Sequence:** 028 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 027 — Discount Rules (`prompts/02-billing/027-discount-rules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 029 until all acceptance criteria below pass.
