# Prompt 033 — Implement Invoices

## Context

- **Sequence:** 033 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 032 — Estimates & Quotations (`prompts/02-billing/032-estimates-and-quotations.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 034 until all acceptance criteria below pass.
