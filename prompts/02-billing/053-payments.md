# Prompt 053 — Implement Payments

## Context

- **Sequence:** 053 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 052 — Bank Reconciliations (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/052-bank-reconciliations.md`).
...
- **AC1 (R1):** `/billing?section=payments` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/payments.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/payments_tab.dart`
