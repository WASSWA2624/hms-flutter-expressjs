# Prompt 025 — Implement Packages & Bundles

## Context

- **Sequence:** 025 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 024 — Price Lists & Tariffs (`prompts/02-billing/024-price-lists-and-tariffs.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 026 until all acceptance criteria below pass.
