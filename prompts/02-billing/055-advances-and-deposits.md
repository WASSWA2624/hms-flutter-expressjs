# Prompt 055 — Implement Advances & Deposits

## Context

- **Sequence:** 055 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 054 — Receipts (`prompts/02-billing/054-receipts.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 056 until all acceptance criteria below pass.
