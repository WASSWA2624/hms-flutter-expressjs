# Prompt 061 — Implement Collection Follow-up

## Context

- **Sequence:** 061 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 060 — Receivables (`prompts/02-billing/060-receivables.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 062 until all acceptance criteria below pass.
