# Prompt 056 — Implement Refunds

## Context

- **Sequence:** 056 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 055 — Advances & Deposits (`prompts/02-billing/055-advances-and-deposits.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 057 until all acceptance criteria below pass.
