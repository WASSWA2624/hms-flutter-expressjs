# Prompt 018 — Implement Write-offs

## Context

- **Sequence:** 018 of 024 in `prompts/02-billing/`
- **Overall step:** 117 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** `Billing → Refunds` (`prompts/02-billing/017-refunds.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Billing → Patient Accounts` (`prompts/02-billing/019-patient-accounts.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/billing/write-offs.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
