# Prompt 054 — Implement Receipts

## Context

- **Sequence:** 054 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 053 — Payment Allocations (`prompts/02-billing/053-payment-allocations.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 055 until all acceptance criteria below pass.
