# Prompt 059 — Implement Patient Statements

## Context

- **Sequence:** 059 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 058 — Patient Accounts (`prompts/02-billing/058-patient-accounts.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 060 until all acceptance criteria below pass.
