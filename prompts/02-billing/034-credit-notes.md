# Prompt 034 — Implement Credit Notes

## Context

- **Sequence:** 034 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 033 — Invoices (`prompts/02-billing/033-invoices.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 035 until all acceptance criteria below pass.
