# Prompt 027 — Implement Discount Rules

## Context

- **Sequence:** 027 of 158
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 026 — Billing Rules (`prompts/02-billing/026-billing-rules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 028 until all acceptance criteria below pass.
