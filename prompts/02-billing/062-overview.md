# Prompt 062 — Implement Overview

## Context

- **Sequence:** 062 of 158
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 061 — Collection Follow-up (`prompts/02-billing/061-collection-follow-up.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 063 until all acceptance criteria below pass.
