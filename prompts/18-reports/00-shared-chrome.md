# Reports shared chrome — rule compliance

## Context

Remediate cross-tab Reports chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/18-reports/00-shared-chrome.md`. Gaps detail: `tabs/18-reports/99-convention-gaps.md`.
...
- [ ] `tabs/18-reports/00-shared-chrome.md` updated to match.
