...
- [x] Every desk section in `tabs/03-opd/00-overview.md` has a completed remediation prompt under `prompts/03-opd/` and a matching updated inventory under `tabs/03-opd/`.
