# Subscriptions shared chrome — rule compliance

## Context

Remediate cross-tab Subscriptions chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/16-subscriptions/00-shared-chrome.md`. Gaps detail: `tabs/16-subscriptions/99-convention-gaps.md`.
...
- [ ] `tabs/16-subscriptions/00-shared-chrome.md` updated to match.
