# Accounts shared chrome — rule compliance

## Context

Remediate cross-tab Accounts chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/14-accounts/00-shared-chrome.md`. Gaps detail: `tabs/14-accounts/99-convention-gaps.md`.
...
- [x] `tabs/14-accounts/00-shared-chrome.md` updated to match.
