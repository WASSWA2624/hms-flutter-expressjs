# Billing & Sections Scan — Settings / Configuration (`/settings?…=configuration`)
...
- Target tab: **Configuration** (`configuration`).
...
- Financial focus for this tab: Price lists, payment-method enablement, tax, waiver policies, and billing configuration must apply through shared Billing price-resolver and payment-method validators; preference screens must not hardcode bypass flags. Tab role: Tenant/facility config; admin any-of.
