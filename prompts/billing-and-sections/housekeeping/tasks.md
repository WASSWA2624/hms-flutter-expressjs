# Billing & Sections Scan — Housekeeping workspace / Tasks (`/housekeeping?…=tasks`)
...
- Financial focus for this tab: Patient-billable room turnover or private-room cleaning surcharges (if configured) must hit Billing; staff-only tasks must remain NOT_BILLED. Tab role: Create task primary.
