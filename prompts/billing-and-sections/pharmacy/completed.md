# Billing & Sections Scan — Pharmacy workspace / Completed (`/pharmacy?…=completed`)
...
- Financial focus for this tab: Dispense, partial fill, and pending-payment gates must collect or confirm settlement through Billing before stock leaves; returns/refunds must reverse or credit Billing lines without duplicate charges. Tab role: Dispensed history; prefer read.
