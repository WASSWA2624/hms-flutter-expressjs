# Billing & Sections Scan — Operations workspace / All requests (`/operations?…=all`)
...
- Financial focus for this tab: Chargeable facility/service requests and billable asset services must post to Billing when they have a patient/encounter payer context; internal-only work must be explicitly NOT_BILLED. Tab role: All facility requests.
