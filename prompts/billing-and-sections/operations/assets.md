# Billing & Sections Scan — Operations workspace / Assets (`/operations?…=assets`)
...
- Financial focus for this tab: Chargeable facility/service requests and billable asset services must post to Billing when they have a patient/encounter payer context; internal-only work must be explicitly NOT_BILLED. Tab role: Facility assets CRUD for writers.
