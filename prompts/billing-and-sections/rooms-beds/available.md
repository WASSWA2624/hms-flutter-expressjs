# Billing & Sections Scan — Rooms & beds / Available (`/rooms-beds?…=available`)
...
- Target tab: **Available** (`available`).
...
- Financial focus for this tab: Bed assignment/turnover that incurs room or bed charges must update Billing line items; out-of-service must not silently drop billable occupancy charges already accrued. Tab role: Create bed primary when bed-admin.
