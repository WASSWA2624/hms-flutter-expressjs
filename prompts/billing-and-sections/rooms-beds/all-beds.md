# Billing & Sections Scan — Rooms & beds / All beds (`/rooms-beds?…=all`)
...
- Financial focus for this tab: Bed assignment/turnover that incurs room or bed charges must update Billing line items; out-of-service must not silently drop billable occupancy charges already accrued. Tab role: Create room primary when bed-admin.
