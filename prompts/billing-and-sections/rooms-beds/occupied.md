# Billing & Sections Scan — Rooms & beds / Occupied (`/rooms-beds?…=occupied`)
...
- Financial focus for this tab: Bed assignment/turnover that incurs room or bed charges must update Billing line items; out-of-service must not silently drop billable occupancy charges already accrued. Tab role: Release/transfer actions for writers.
