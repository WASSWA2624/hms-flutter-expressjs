# Billing & Sections Scan — ICU workspace / Ended stays (`/icu?…=ended`)
...
- Financial focus for this tab: ICU bed/day, critical-care packages, transfers, and discharge-ready financial gates must integrate with Billing the same way as IPD, without cashier workflows owning clinical actions. Tab role: Historical stays; prefer read-only.
