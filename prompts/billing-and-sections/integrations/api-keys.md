# Billing & Sections Scan — Integrations workspace / API keys (`/integrations?…=api-keys`)
...
- Screen inventory: `screens/integrations.md` (read-only reference for reachable controls; do not modify).
