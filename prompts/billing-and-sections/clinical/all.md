# Billing & Sections Scan — Clinical workspace / All (`/clinical?…=all`)
...
- Financial focus for this tab: Orders and completed services (procedures, follow-up visits, results that unlock chargeable acts) must ensure request-time or completion-time billing hooks fire; unpaid required charges must surface consistently. Tab role: Outpatient clinical worklist.
