# Billing & Sections Scan — Clinical workspace / In consultation (`/clinical?…=in-consultation`)
...
- Target tab: **In consultation** (`in-consultation`).
...
- Financial focus for this tab: Orders and completed services (procedures, follow-up visits, results that unlock chargeable acts) must ensure request-time or completion-time billing hooks fire; unpaid required charges must surface consistently. Tab role: Active consultation; richest nested action bar.
