# Billing & Sections Scan — Clinical workspace / Urgent (`/clinical?…=urgent`)
...
- Financial focus for this tab: Orders and completed services (procedures, follow-up visits, results that unlock chargeable acts) must ensure request-time or completion-time billing hooks fire; unpaid required charges must surface consistently. Tab role: Urgent encounters.
