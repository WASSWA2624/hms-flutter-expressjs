# Billing & Sections Scan — Clinical workspace / Waiting review (`/clinical?…=waiting-review`)
...
- Target tab: **Waiting review** (`waiting-review`).
...
- Financial focus for this tab: Orders and completed services (procedures, follow-up visits, results that unlock chargeable acts) must ensure request-time or completion-time billing hooks fire; unpaid required charges must surface consistently. Tab role: Awaiting clinician review.
