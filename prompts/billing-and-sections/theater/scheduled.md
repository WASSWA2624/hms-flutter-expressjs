# Billing & Sections Scan — Theater workspace / Scheduled (`/theater?…=scheduled`)
...
- Target tab: **Scheduled** (`scheduled`).
...
- Financial focus for this tab: Theatre/procedure packages, consumables, implants, and pre-op billing gates must create Billing lines; recovery completion must not skip unsettled required charges without documented deferral. Tab role: Schedule case primary.
