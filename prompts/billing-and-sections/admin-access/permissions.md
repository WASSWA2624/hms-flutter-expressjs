# Billing & Sections Scan — Access admin / Permissions (`/admin/access?…=permissions`)
...
- Target tab: **Permissions** (`permissions`).
...
- Financial focus for this tab: Role/entitlement changes that grant billing permissions must not alter historical ledgers. Demo/seed financial data must use Billing factories, not orphan amounts. Tab role: Permission catalog; edits elevated only.
