# Billing & Sections Scan — Access admin / Entitlements (`/admin/access?…=entitlements`)
...
- Target tab: **Entitlements** (`entitlements`).
...
- Financial focus for this tab: Role/entitlement changes that grant billing permissions must not alter historical ledgers. Demo/seed financial data must use Billing factories, not orphan amounts. Tab role: Module entitlements; subscription ∩ admin.
