# Billing & Sections Scan — Communications workspace / Messages (`/communications?…=messages`)
...
- Financial focus for this tab: Paid notification/SMS packages are tenant commercial charges if present; patient clinical Billing must not be bypassed by message send actions that imply paid care delivery. Tab role: Inbox; New message/group primaries.
