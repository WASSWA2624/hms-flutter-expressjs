# Billing & Sections Scan — Nursing workspace / Medication due (`/nursing?…=medication-due`)
...
- Target tab: **Medication due** (`medication-due`).
...
- Financial focus for this tab: Billable nursing procedures, consumables, medication administrations tied to chargeable items, and discharge-pending financial checks must post through Billing / clinical-request billing—not nurse-local tallies. Tab role: Due meds; pharmacy:read ∩ clinical:write for charting/admin.
