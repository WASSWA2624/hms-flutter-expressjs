# Billing & Sections Scan — Nursing workspace / Transfer pending (`/nursing?…=transfer-pending`)
...
- Target tab: **Transfer pending** (`transfer-pending`).
...
- Financial focus for this tab: Billable nursing procedures, consumables, medication administrations tied to chargeable items, and discharge-pending financial checks must post through Billing / clinical-request billing—not nurse-local tallies. Tab role: Transfer execute needs clinical:write.
