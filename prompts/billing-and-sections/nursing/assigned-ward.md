# Billing & Sections Scan — Nursing workspace / Assigned ward (`/nursing?…=assigned-ward`)
...
- Target tab: **Assigned ward** (`assigned-ward`).
...
- Financial focus for this tab: Billable nursing procedures, consumables, medication administrations tied to chargeable items, and discharge-pending financial checks must post through Billing / clinical-request billing—not nurse-local tallies. Tab role: ABAC ward/assignment scope preferred.
