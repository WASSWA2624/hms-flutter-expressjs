# Billing & Sections Scan — Nursing workspace / Handover pending (`/nursing?…=handover-pending`)
...
- Target tab: **Handover pending** (`handover-pending`).
...
- Financial focus for this tab: Billable nursing procedures, consumables, medication administrations tied to chargeable items, and discharge-pending financial checks must post through Billing / clinical-request billing—not nurse-local tallies. Tab role: Shift handover complete needs clinical:write.
