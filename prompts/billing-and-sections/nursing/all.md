# Billing & Sections Scan — Nursing workspace / All (`/nursing?…=all`)
...
- Financial focus for this tab: Billable nursing procedures, consumables, medication administrations tied to chargeable items, and discharge-pending financial checks must post through Billing / clinical-request billing—not nurse-local tallies. Tab role: Full nursing worklist.
