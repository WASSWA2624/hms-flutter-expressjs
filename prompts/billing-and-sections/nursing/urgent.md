# Billing & Sections Scan — Nursing workspace / Urgent (`/nursing?…=urgent`)
...
- Financial focus for this tab: Billable nursing procedures, consumables, medication administrations tied to chargeable items, and discharge-pending financial checks must post through Billing / clinical-request billing—not nurse-local tallies. Tab role: Urgent nursing tasks.
