# Billing & Sections Scan — Reception desk / Follow-ups (`/reception?…=follow-ups`)
...
- Target tab: **Follow-ups** (`follow-ups`).
...
- Financial focus for this tab: Desk flows often gate clinical progress on payment. Appointments, queue, visits, and payment-gate actions that collect fees, deposits, or clear holds must settle through Billing—not local-only flags. Tab role: Follow-up worklist; complete/reschedule gated by write rights.
