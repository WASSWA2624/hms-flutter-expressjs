# Billing & Sections Scan — Mortuary workspace / Intake (`/mortuary?…=intake`)
...
- Financial focus for this tab: Intake storage fees, embalming, viewing, and release charges must create Billing invoices; custody transfers must preserve payer and balance continuity. Tab role: Receive case; mortuary:write.
