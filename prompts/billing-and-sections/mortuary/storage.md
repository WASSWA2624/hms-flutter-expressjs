# Billing & Sections Scan — Mortuary workspace / Storage (`/mortuary?…=storage`)
...
- Financial focus for this tab: Intake storage fees, embalming, viewing, and release charges must create Billing invoices; custody transfers must preserve payer and balance continuity. Tab role: Assign storage; mortuary:manage_storage.
