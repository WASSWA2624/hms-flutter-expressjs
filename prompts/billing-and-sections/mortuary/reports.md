# Billing & Sections Scan — Mortuary workspace / Reports (`/mortuary?…=reports`)
...
- Financial focus for this tab: Intake storage fees, embalming, viewing, and release charges must create Billing invoices; custody transfers must preserve payer and balance continuity. Tab role: Exports/audit; mortuary:export / mortuary:audit.
