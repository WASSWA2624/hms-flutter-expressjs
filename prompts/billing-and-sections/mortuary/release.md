# Billing & Sections Scan — Mortuary workspace / Release (`/mortuary?…=release`)
...
- Financial focus for this tab: Intake storage fees, embalming, viewing, and release charges must create Billing invoices; custody transfers must preserve payer and balance continuity. Tab role: Body release; mortuary:release (often ∩ approve).
