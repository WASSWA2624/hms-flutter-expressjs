# Billing & Sections Scan — Physiotherapy workspace / Referrals (`/physiotherapy?…=referrals`)
...
- Target tab: **Referrals** (`referrals`).
...
- Financial focus for this tab: Therapy session packs, individual sessions, missed-session fees (if policy), and referral acceptance that starts a paid plan must create Billing records and settle before or per package rules. Tab role: Incoming therapy referrals.
