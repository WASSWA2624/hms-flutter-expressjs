# Billing & Sections Scan — Claims workspace / Authorizations (`/claims?…=authorizations`)
...
- Target tab: **Authorizations** (`authorizations`).
...
- Financial focus for this tab: Primary focus: pre-auth limits and covered amounts must constrain Billing coverage splits. Authorizations, claim prep/submit/amend, settlement, co-pay, and insurance catalog pricing must keep patient invoices, coverage splits, and remittances synchronized with Billing. Tab role: Request/update pre-authorizations.
