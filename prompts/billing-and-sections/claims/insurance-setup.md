# Billing & Sections Scan — Claims workspace / Insurance Setup (`/claims?…=insurance-setup`)
...
- Target tab: **Insurance Setup** (`insurance-setup`).
...
- Financial focus for this tab: Authorizations, claim prep/submit/amend, settlement, co-pay, and insurance catalog pricing must keep patient invoices, coverage splits, and remittances synchronized with Billing. Tab role: Payers/plans/catalog; create/edit need billing:write (or facility admin).
