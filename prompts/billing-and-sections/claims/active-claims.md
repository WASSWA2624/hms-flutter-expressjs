# Billing & Sections Scan — Claims workspace / Active Claims (`/claims?…=active-claims`)
...
- Target tab: **Active Claims** (`active-claims`).
...
- Financial focus for this tab: Authorizations, claim prep/submit/amend, settlement, co-pay, and insurance catalog pricing must keep patient invoices, coverage splits, and remittances synchronized with Billing. Tab role: Prepare, submit, amend active claims.
