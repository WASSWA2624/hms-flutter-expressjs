# Billing & Sections Scan — IPD workspace / Follow-ups (`/ipd?…=follow-ups`)
...
- Financial focus for this tab: Admission deposits, bed/day charges, transfers that change rate, consumables, and discharge financial clearance must post to Billing. Do not clear discharge without settling or explicitly recording outstanding balances. Tab role: Shared follow-ups; no Start admission.
