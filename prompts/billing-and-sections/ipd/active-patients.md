# Billing & Sections Scan — IPD workspace / Active Patients (`/ipd?…=active`)
...
- Target tab: **Active Patients** (`active`).
...
- Financial focus for this tab: Admission deposits, bed/day charges, transfers that change rate, consumables, and discharge financial clearance must post to Billing. Do not clear discharge without settling or explicitly recording outstanding balances. Tab role: Current inpatients.
