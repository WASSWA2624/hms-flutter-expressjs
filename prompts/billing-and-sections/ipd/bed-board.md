# Billing & Sections Scan — IPD workspace / Bed board (`/ipd?…=bed-board`)
...
- Target tab: **Bed board** (`bed-board`).
...
- Financial focus for this tab: Admission deposits, bed/day charges, transfers that change rate, consumables, and discharge financial clearance must post to Billing. Do not clear discharge without settling or explicitly recording outstanding balances. Tab role: Occupancy board; Manage beds needs bed-admin rights.
