# Billing & Sections Scan — IPD workspace / Discharge (`/ipd?…=discharge`)
...
- Target tab: **Discharge** (`discharge`).
...
- Financial focus for this tab: Primary focus: final bill, refunds of unused deposits, and outstanding balance handling before discharge. Admission deposits, bed/day charges, transfers that change rate, consumables, and discharge financial clearance must post to Billing. Do not clear discharge without settling or explicitly recording outstanding balances. Tab role: Discharge planning handoff; may need billing:read for clearance.
