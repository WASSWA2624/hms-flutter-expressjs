# Billing & Sections Scan — Biomedical workspace / Compliance (`/biomedical?…=compliance`)
...
- Target tab: **Compliance** (`compliance`).
...
- Financial focus for this tab: Patient-billable device usage or implantable/consumable charges must post to Billing; internal maintenance work orders must stay NOT_BILLED. Tab role: Recalls/downtime; compliance:read may union.
