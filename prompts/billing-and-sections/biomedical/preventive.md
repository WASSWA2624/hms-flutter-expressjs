# Billing & Sections Scan — Biomedical workspace / Preventive (`/biomedical?…=preventive`)
...
- Target tab: **Preventive** (`preventive`).
...
- Financial focus for this tab: Patient-billable device usage or implantable/consumable charges must post to Billing; internal maintenance work orders must stay NOT_BILLED. Tab role: Schedule maintenance primary.
