# Billing & Sections Scan — Biomedical workspace / Work orders (`/biomedical?…=work-orders`)
...
- Target tab: **Work orders** (`work-orders`).
...
- Financial focus for this tab: Patient-billable device usage or implantable/consumable charges must post to Billing; internal maintenance work orders must stay NOT_BILLED. Tab role: Create work order primary.
