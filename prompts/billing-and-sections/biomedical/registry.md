# Billing & Sections Scan — Biomedical workspace / Registry (`/biomedical?…=registry`)
...
- Financial focus for this tab: Patient-billable device usage or implantable/consumable charges must post to Billing; internal maintenance work orders must stay NOT_BILLED. Tab role: Register asset primary.
