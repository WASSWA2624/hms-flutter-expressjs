# Billing & Sections Scan — Profile / Profile (`/profile?…=profile`)
...
- Screen inventory: `screens/profile.md` (reachable controls).
- Target tab: **Profile** (`profile`).
- Feature code: `frontend/lib/features/profile/`
- Module entitlement: `profile`
...
- Financial focus for this tab: Home/reports/profile may surface balances, payment shortcuts, or financial KPIs—these must read live Billing state and open canonical Billing/reception flows, never shadow ledgers. Tab role: View/edit profile and change password.
