# Billing & Sections Scan — Lab workspace / Verified (`/lab?…=verified`)
...
- Financial focus for this tab: Every lab order/request must create billable lines via clinical-request billing; verification/release must not orphan unpaid required tests unless NOT_REQUIRED / NO_CHARGE is explicit and audited. Tab role: Released results; prefer read.
