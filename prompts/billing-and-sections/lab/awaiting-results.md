# Billing & Sections Scan — Lab workspace / Awaiting results (`/lab?…=awaiting-results`)
...
- Target tab: **Awaiting results** (`awaiting-results`).
...
- Financial focus for this tab: Every lab order/request must create billable lines via clinical-request billing; verification/release must not orphan unpaid required tests unless NOT_REQUIRED / NO_CHARGE is explicit and audited. Tab role: Pending result entry.
