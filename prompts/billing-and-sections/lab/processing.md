# Billing & Sections Scan — Lab workspace / Processing (`/lab?…=processing`)
...
- Target tab: **Processing** (`processing`).
...
- Financial focus for this tab: Every lab order/request must create billable lines via clinical-request billing; verification/release must not orphan unpaid required tests unless NOT_REQUIRED / NO_CHARGE is explicit and audited. Tab role: In-lab processing.
