# Billing & Sections Scan — Lab workspace / Follow-ups (`/lab?…=follow-ups`)
...
- Financial focus for this tab: Every lab order/request must create billable lines via clinical-request billing; verification/release must not orphan unpaid required tests unless NOT_REQUIRED / NO_CHARGE is explicit and audited. Tab role: No Create Order primary.
