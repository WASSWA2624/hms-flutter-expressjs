# Billing & Sections Scan — Radiology workspace / All orders (`/radiology?…=all`)
...
- Financial focus for this tab: Imaging orders must bill at request (or documented exception); reporting/release must keep payment status consistent with Billing. Tab role: Unfiltered orders.
