# Billing & Sections Scan — Radiology workspace / Worklist (`/radiology?…=worklist`)
...
- Financial focus for this tab: Imaging orders must bill at request (or documented exception); reporting/release must keep payment status consistent with Billing. Tab role: Acquisition worklist.
