# Billing & Sections Scan — Radiology workspace / Released (`/radiology?…=released`)
...
- Financial focus for this tab: Imaging orders must bill at request (or documented exception); reporting/release must keep payment status consistent with Billing. Tab role: Released reports; prefer read.
