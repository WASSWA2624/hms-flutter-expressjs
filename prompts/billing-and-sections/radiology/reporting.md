# Billing & Sections Scan — Radiology workspace / Reporting (`/radiology?…=reporting`)
...
- Target tab: **Reporting** (`reporting`).
...
- Financial focus for this tab: Imaging orders must bill at request (or documented exception); reporting/release must keep payment status consistent with Billing. Tab role: Report drafting/signing.
