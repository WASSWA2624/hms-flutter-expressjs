# Billing & Sections Scan — Discharge workspace / Completed (`/discharge?…=completed`)
...
- Financial focus for this tab: Financial clearance, pharmacy returns, outstanding balances, waivers, and final invoices must complete via Billing before discharge closure; link to Billing workspace instead of duplicating payment logic. Tab role: Completed discharges; prefer read.
