# Billing & Sections Scan — Patients registry / All patients (`/patients?…=all`)
...
- Financial focus for this tab: Patient registration itself is free, but nested quick actions that request consults, labs, imaging, pharmacy, procedures, admission, insurance enrollment, deposits, or collect balances must create or update Billing records. Balance-due surfaces must reflect live outstanding balances from Billing. Tab role: Full registry list; Register patient + Duplicate review on strip.
