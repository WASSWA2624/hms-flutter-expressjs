# Billing & Sections Scan — Patients registry / Active (`/patients?…=active`)
...
- Financial focus for this tab: Patient registration itself is free, but nested quick actions that request consults, labs, imaging, pharmacy, procedures, admission, insurance enrollment, deposits, or collect balances must create or update Billing records. Balance-due surfaces must reflect live outstanding balances from Billing. Tab role: Active outpatients / open visits; same CRUD as registry.
