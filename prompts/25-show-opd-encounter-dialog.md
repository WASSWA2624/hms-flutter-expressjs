...
| Verified definition | `frontend/lib/shared/components/opd_encounter_dialog.dart:2222` |
...
2. Opener preserves its argument/result API, uses the approved helper, and enforces the correct barrier; hosted-dialog footer work stays in its owner.
...
6. Body sections and action groups reuse canonical shared primitives; no unjustified local forks (siblings considered: `OpdEncounterDialog`, `PatientPinnedOpdEncounterDialog`).
