# Claims shared chrome — rule compliance

## Context

Remediate cross-tab Claims chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/15-claims/00-shared-chrome.md`. Gaps detail: `tabs/15-claims/99-convention-gaps.md`.
...
- [ ] `tabs/15-claims/00-shared-chrome.md` updated to match.
