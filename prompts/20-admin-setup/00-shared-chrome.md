# Admin setup shared chrome — rule compliance

## Context

Remediate cross-tab Admin setup chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/20-admin-setup/00-shared-chrome.md`. Gaps detail: `tabs/20-admin-setup/99-convention-gaps.md`.
...
- [ ] `tabs/20-admin-setup/00-shared-chrome.md` updated to match.
