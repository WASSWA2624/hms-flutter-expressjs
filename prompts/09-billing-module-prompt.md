...
- **Multi-tier pricing engine** — see root [`prompt.md`](../prompt.md) for insurance company → scheme → offers, price book, co-pay splits, pharmacy/facility billing entities, and insurer adapters now landing across shared clinical billing.
