# HR shared chrome — rule compliance

## Context

Remediate cross-tab HR chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/17-hr/00-shared-chrome.md`. Gaps detail: `tabs/17-hr/99-convention-gaps.md`.
...
- [ ] `tabs/17-hr/00-shared-chrome.md` updated to match.
