# Clinical shared chrome — rule compliance

## Context

Remediate cross-tab Clinical chrome so it fully complies with `screens.mdc`, `tabs.mdc`, `tables.mdc`, `dialogs.mdc`, `forms.mdc`, and `printing.mdc`. Inventory baseline: `tabs/07-clinical/00-shared-chrome.md`. Gaps detail: `tabs/07-clinical/99-convention-gaps.md`.
...
- [ ] `tabs/07-clinical/00-shared-chrome.md` updated to match.
