# Billing Integration Scan — Billing workspace / Overdue (`/billing?…=overdue`)
...
- Financial focus for this tab: Primary focus: dunning, adjustments, waivers, and collections that keep overdue balances reconciled. This is the Billing system of record. Validate issue, receive payment, refund, adjust, waive, void, credit note, claim handoff, approval, dunning, shift/day close, ledger, and reconciliation end-to-end with supported payment methods and realtime UI sync. Tab role: Collections follow-up; write for dunning / adjust / waive.
