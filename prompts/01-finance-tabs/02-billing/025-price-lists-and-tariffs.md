# Prompt 025 — Implement Price Lists & Tariffs

## Context

- **Sequence:** 025 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 024 — Reversing Entries (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/024-reversing-entries.md`).
...
- **AC1 (R1):** `/billing?section=price-lists-and-tariffs` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/price-lists-and-tariffs.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/price_lists_and_tariffs_tab.dart`
