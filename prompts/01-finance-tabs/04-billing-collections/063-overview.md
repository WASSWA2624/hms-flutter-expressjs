# Prompt 063 — Implement Overview

## Context

- **Sequence:** 063 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 062 — Collection Follow-up (`prompts/01-finance-tabs/04-billing-collections/062-collection-follow-up.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 064 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/billing?section=overview` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/overview.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/overview_tab.dart`
