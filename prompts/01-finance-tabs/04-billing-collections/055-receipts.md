# Prompt 055 — Implement Receipts

## Context

- **Sequence:** 055 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 054 — Payment Allocations (`prompts/01-finance-tabs/04-billing-collections/054-payment-allocations.md`).
...
- **AC1 (R1):** `/billing?section=receipts` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/receipts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/receipts_tab.dart`
