# Prompt 061 — Implement Receivables

## Context

- **Sequence:** 061 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 060 — Patient Statements (`prompts/01-finance-tabs/04-billing-collections/060-patient-statements.md`).
...
- **AC1 (R1):** `/billing?section=receivables` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/receivables.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/receivables_tab.dart`
