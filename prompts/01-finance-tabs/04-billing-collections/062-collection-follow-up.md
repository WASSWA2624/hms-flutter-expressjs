# Prompt 062 — Implement Collection Follow-up

## Context

- **Sequence:** 062 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 061 — Receivables (`prompts/01-finance-tabs/04-billing-collections/061-receivables.md`).
...
- **AC1 (R1):** `/billing?section=collection-follow-up` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/collection-follow-up.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/collection_follow_up_tab.dart`
