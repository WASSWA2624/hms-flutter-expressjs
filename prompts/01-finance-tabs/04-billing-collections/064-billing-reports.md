# Prompt 064 — Implement Billing Reports

## Context

- **Sequence:** 064 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 063 — Overview (`prompts/01-finance-tabs/04-billing-collections/063-overview.md`).
...
- **AC1 (R1):** `/billing?section=billing-reports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/billing-reports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/billing_reports_tab.dart`
