# Prompt 059 — Implement Patient Accounts

## Context

- **Sequence:** 059 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 058 — Write-offs (`prompts/01-finance-tabs/04-billing-collections/058-write-offs.md`).
...
- **AC1 (R1):** `/billing?section=patient-accounts` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/patient-accounts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/patient_accounts_tab.dart`
