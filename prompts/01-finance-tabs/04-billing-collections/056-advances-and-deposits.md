# Prompt 056 — Implement Advances & Deposits

## Context

- **Sequence:** 056 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 055 — Receipts (`prompts/01-finance-tabs/04-billing-collections/055-receipts.md`).
...
- **AC1 (R1):** `/billing?section=advances-and-deposits` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/advances-and-deposits.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/advances_and_deposits_tab.dart`
