# Prompt 060 — Implement Patient Statements

## Context

- **Sequence:** 060 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 059 — Patient Accounts (`prompts/01-finance-tabs/04-billing-collections/059-patient-accounts.md`).
...
- **AC1 (R1):** `/billing?section=patient-statements` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/patient-statements.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/patient_statements_tab.dart`
