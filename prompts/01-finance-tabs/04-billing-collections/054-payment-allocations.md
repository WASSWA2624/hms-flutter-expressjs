# Prompt 054 — Implement Payment Allocations

## Context

- **Sequence:** 054 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 053 — Payments (`prompts/01-finance-tabs/04-billing-collections/053-payments.md`).
...
- **AC1 (R1):** `/billing?section=payment-allocations` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/payment-allocations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/payment_allocations_tab.dart`
