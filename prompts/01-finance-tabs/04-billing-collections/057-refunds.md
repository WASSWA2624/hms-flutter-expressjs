# Prompt 057 — Implement Refunds

## Context

- **Sequence:** 057 of 159
- **Phase:** Billing collections and receivables
- **Prerequisite:** Prompt 056 — Advances & Deposits (`prompts/01-finance-tabs/04-billing-collections/056-advances-and-deposits.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 058 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/billing?section=refunds` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/refunds.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/refunds_tab.dart`
