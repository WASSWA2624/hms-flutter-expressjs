# Prompt 152 — Implement Cashier & Bank Reports

## Context

- **Sequence:** 152 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 151 — Department Performance (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/151-department-performance.md`).
...
- **AC1 (R1):** `/accounts?section=cashier-and-bank-reports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/cashier-and-bank-reports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cashier_and_bank_reports_tab.dart`
