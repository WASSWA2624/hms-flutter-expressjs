# Prompt 149 — Implement General Ledger Report

## Context

- **Sequence:** 149 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 148 — Cash Flow Statement (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/148-cash-flow-statement.md`).
...
- **AC1 (R1):** `/accounts?section=general-ledger-report` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/general-ledger-report.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/general_ledger_report_tab.dart`
