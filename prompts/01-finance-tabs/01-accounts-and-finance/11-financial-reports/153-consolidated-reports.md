# Prompt 153 — Implement Consolidated Reports

## Context

- **Sequence:** 153 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 152 — Cashier & Bank Reports (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/152-cashier-and-bank-reports.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 154 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=consolidated-reports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/consolidated-reports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/consolidated_reports_tab.dart`
