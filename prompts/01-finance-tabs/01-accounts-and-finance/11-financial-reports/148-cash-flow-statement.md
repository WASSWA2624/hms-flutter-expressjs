# Prompt 148 — Implement Cash Flow Statement

## Context

- **Sequence:** 148 of 159
- **Phase:** Accounts operations — financial reports
- **Prerequisite:** Prompt 147 — Balance Sheet (`prompts/01-finance-tabs/01-accounts-and-finance/11-financial-reports/147-balance-sheet.md`).
...
- **AC1 (R1):** `/accounts?section=cash-flow-statement` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/financial-reports/cash-flow-statement.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_flow_statement_tab.dart`
