# Prompt 119 — Implement Asset Categories

## Context

- **Sequence:** 119 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 118 — Asset Register (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/118-asset-register.md`).
...
- **AC1 (R1):** `/accounts?section=asset-categories` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/asset-categories.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/asset_categories_tab.dart`
