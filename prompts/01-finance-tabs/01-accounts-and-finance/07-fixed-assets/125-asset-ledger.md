# Prompt 125 — Implement Asset Ledger

## Context

- **Sequence:** 125 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 124 — Disposals (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/124-disposals.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 126 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=asset-ledger` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/asset-ledger.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/asset_ledger_tab.dart`
