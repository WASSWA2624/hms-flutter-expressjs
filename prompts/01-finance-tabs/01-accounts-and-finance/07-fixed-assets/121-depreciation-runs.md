# Prompt 121 — Implement Depreciation Runs

## Context

- **Sequence:** 121 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 120 — Asset Acquisitions (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/120-asset-acquisitions.md`).
...
- **AC1 (R1):** `/accounts?section=depreciation-runs` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/depreciation-runs.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/depreciation_runs_tab.dart`
