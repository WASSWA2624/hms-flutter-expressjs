# Prompt 124 — Implement Disposals

## Context

- **Sequence:** 124 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 123 — Revaluations (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/123-revaluations.md`).
...
- **AC1 (R1):** `/accounts?section=disposals` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/disposals.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/disposals_tab.dart`
