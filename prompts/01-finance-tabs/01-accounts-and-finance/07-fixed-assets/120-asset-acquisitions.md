# Prompt 120 — Implement Asset Acquisitions

## Context

- **Sequence:** 120 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 119 — Asset Categories (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/119-asset-categories.md`).
...
- **AC1 (R1):** `/accounts?section=asset-acquisitions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/asset-acquisitions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/asset_acquisitions_tab.dart`
