# Prompt 122 — Implement Asset Transfers

## Context

- **Sequence:** 122 of 159
- **Phase:** Accounts operations — fixed assets
- **Prerequisite:** Prompt 121 — Depreciation Runs (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/121-depreciation-runs.md`).
...
- **AC1 (R1):** `/accounts?section=asset-transfers` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/fixed-assets/asset-transfers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/asset_transfers_tab.dart`
