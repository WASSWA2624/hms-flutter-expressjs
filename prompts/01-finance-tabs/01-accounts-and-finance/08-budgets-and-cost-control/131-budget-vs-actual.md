# Prompt 131 — Implement Budget vs Actual

## Context

- **Sequence:** 131 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 130 — Commitments (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/130-commitments.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 132 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=budget-vs-actual` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/budget-vs-actual.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/budget_vs_actual_tab.dart`
