# Prompt 126 — Implement Annual Budgets

## Context

- **Sequence:** 126 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 125 — Asset Ledger (`prompts/01-finance-tabs/01-accounts-and-finance/07-fixed-assets/125-asset-ledger.md`).
...
- **AC1 (R1):** `/accounts?section=annual-budgets` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/annual-budgets.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/annual_budgets_tab.dart`
