# Prompt 129 — Implement Budget Revisions

## Context

- **Sequence:** 129 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 128 — Project Budgets (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/128-project-budgets.md`).
...
- **AC1 (R1):** `/accounts?section=budget-revisions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/budget-revisions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/budget_revisions_tab.dart`
