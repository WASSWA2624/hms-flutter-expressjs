# Prompt 128 — Implement Project Budgets

## Context

- **Sequence:** 128 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 127 — Department Budgets (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/127-department-budgets.md`).
...
- **AC1 (R1):** `/accounts?section=project-budgets` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/project-budgets.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/project_budgets_tab.dart`
