# Prompt 130 — Implement Commitments

## Context

- **Sequence:** 130 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 129 — Budget Revisions (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/129-budget-revisions.md`).
...
- **AC1 (R1):** `/accounts?section=commitments` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/commitments.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/commitments_tab.dart`
