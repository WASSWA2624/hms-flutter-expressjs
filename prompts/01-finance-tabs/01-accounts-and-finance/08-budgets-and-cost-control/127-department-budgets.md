# Prompt 127 — Implement Department Budgets

## Context

- **Sequence:** 127 of 159
- **Phase:** Accounts operations — budgets and cost control
- **Prerequisite:** Prompt 126 — Annual Budgets (`prompts/01-finance-tabs/01-accounts-and-finance/08-budgets-and-cost-control/126-annual-budgets.md`).
...
- **AC1 (R1):** `/accounts?section=department-budgets` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/budgets-and-cost-control/department-budgets.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/department_budgets_tab.dart`
