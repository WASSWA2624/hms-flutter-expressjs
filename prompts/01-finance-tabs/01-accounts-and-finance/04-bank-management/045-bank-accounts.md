# Prompt 045 — Implement Bank Accounts

## Context

- **Sequence:** 045 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 044 — Cash Reconciliation (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/044-cash-reconciliation.md`).
...
- **AC1 (R1):** `/accounts?section=bank-accounts` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/bank-accounts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/bank_accounts_tab.dart`
