# Prompt 050 — Implement Statement Imports

## Context

- **Sequence:** 050 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 049 — Bank Transfers (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/049-bank-transfers.md`).
...
- **AC1 (R1):** `/accounts?section=statement-imports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/statement-imports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/statement_imports_tab.dart`
