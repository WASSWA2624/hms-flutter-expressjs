# Prompt 047 — Implement Bank Deposits

## Context

- **Sequence:** 047 of 159
- **Phase:** Treasury foundation — bank management
- **Prerequisite:** Prompt 046 — Bank Transactions (`prompts/01-finance-tabs/01-accounts-and-finance/04-bank-management/046-bank-transactions.md`).
...
- **AC1 (R1):** `/accounts?section=bank-deposits` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/bank-management/bank-deposits.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/bank_deposits_tab.dart`
