# Prompt 138 — Implement Audit Schedules

## Context

- **Sequence:** 138 of 159
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 137 — Regulatory Reports (`prompts/01-finance-tabs/01-accounts-and-finance/09-tax-and-compliance/137-regulatory-reports.md`).
...
- **AC1 (R1):** `/accounts?section=audit-schedules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/tax-and-compliance/audit-schedules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/audit_schedules_tab.dart`
