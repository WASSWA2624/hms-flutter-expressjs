# Prompt 135 — Implement Withholding Tax

## Context

- **Sequence:** 135 of 159
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 134 — Tax Transactions (`prompts/01-finance-tabs/01-accounts-and-finance/09-tax-and-compliance/134-tax-transactions.md`).
...
- **AC1 (R1):** `/accounts?section=withholding-tax` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/tax-and-compliance/withholding-tax.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/withholding_tax_tab.dart`
