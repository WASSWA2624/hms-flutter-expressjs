# Prompt 136 — Implement Tax Returns

## Context

- **Sequence:** 136 of 159
- **Phase:** Accounts operations — tax and compliance
- **Prerequisite:** Prompt 135 — Withholding Tax (`prompts/01-finance-tabs/01-accounts-and-finance/09-tax-and-compliance/135-withholding-tax.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 137 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=tax-returns` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/tax-and-compliance/tax-returns.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/tax_returns_tab.dart`
