# Prompt 044 — Implement Cash Reconciliation

## Context

- **Sequence:** 044 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 043 — Cash Variances (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/043-cash-variances.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 045 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=cash-reconciliation` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cash-reconciliation.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_reconciliation_tab.dart`
