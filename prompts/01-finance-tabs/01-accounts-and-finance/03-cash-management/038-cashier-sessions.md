# Prompt 038 — Implement Cashier Sessions

## Context

- **Sequence:** 038 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 037 — Cash Points (`prompts/01-finance-tabs/01-accounts-and-finance/03-cash-management/037-cash-points.md`).
...
- **AC1 (R1):** `/accounts?section=cashier-sessions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cashier-sessions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cashier_sessions_tab.dart`
