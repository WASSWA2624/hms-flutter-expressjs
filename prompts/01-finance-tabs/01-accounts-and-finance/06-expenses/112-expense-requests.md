# Prompt 112 — Implement Expense Requests

## Context

- **Sequence:** 112 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 111 — Expense Entries (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/111-expense-entries.md`).
...
- **AC1 (R1):** `/accounts?section=expense-requests` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/expense-requests.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/expense_requests_tab.dart`
