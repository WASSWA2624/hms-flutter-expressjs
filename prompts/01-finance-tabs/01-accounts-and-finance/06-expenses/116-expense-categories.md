# Prompt 116 — Implement Expense Categories

## Context

- **Sequence:** 116 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 115 — Staff Reimbursements (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/115-staff-reimbursements.md`).
...
- **AC1 (R1):** `/accounts?section=expense-categories` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/expense-categories.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/expense_categories_tab.dart`
