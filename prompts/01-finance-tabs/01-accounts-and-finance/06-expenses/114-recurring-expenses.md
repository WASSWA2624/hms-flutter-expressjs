# Prompt 114 — Implement Recurring Expenses

## Context

- **Sequence:** 114 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 113 — Expense Approvals (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/113-expense-approvals.md`).
...
- **AC1 (R1):** `/accounts?section=recurring-expenses` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/recurring-expenses.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/recurring_expenses_tab.dart`
