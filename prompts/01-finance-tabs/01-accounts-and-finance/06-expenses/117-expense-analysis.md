# Prompt 117 — Implement Expense Analysis

## Context

- **Sequence:** 117 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 116 — Expense Categories (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/116-expense-categories.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 118 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=expense-analysis` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/expense-analysis.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/expense_analysis_tab.dart`
