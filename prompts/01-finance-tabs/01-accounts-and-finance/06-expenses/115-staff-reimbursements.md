# Prompt 115 — Implement Staff Reimbursements

## Context

- **Sequence:** 115 of 159
- **Phase:** Accounts operations — expenses
- **Prerequisite:** Prompt 114 — Recurring Expenses (`prompts/01-finance-tabs/01-accounts-and-finance/06-expenses/114-recurring-expenses.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 116 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=staff-reimbursements` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/expenses/staff-reimbursements.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/staff_reimbursements_tab.dart`
