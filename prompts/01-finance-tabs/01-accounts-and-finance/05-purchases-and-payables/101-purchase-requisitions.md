# Prompt 101 — Implement Purchase Requisitions

## Context

- **Sequence:** 101 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 100 — Suppliers (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/100-suppliers.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 102 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=purchase-requisitions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/purchase-requisitions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/purchase_requisitions_tab.dart`
