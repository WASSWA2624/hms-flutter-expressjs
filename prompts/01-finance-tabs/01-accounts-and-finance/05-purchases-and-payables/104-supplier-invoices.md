# Prompt 104 — Implement Supplier Invoices

## Context

- **Sequence:** 104 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 103 — Goods Received Notes (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/103-goods-received-notes.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 105 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=supplier-invoices` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-invoices.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/supplier_invoices_tab.dart`
