# Prompt 108 — Implement Supplier Statements

## Context

- **Sequence:** 108 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 107 — Supplier Payments (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/107-supplier-payments.md`).
...
- **AC1 (R1):** `/accounts?section=supplier-statements` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-statements.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/supplier_statements_tab.dart`
