# Prompt 110 — Implement AP Reconciliation

## Context

- **Sequence:** 110 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 109 — AP Aging (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/109-ap-aging.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 111 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=ap-reconciliation` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/ap-reconciliation.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/ap_reconciliation_tab.dart`
