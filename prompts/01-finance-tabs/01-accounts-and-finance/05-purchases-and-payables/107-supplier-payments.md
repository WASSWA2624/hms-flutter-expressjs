# Prompt 107 — Implement Supplier Payments

## Context

- **Sequence:** 107 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 106 — Payment Runs (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/106-payment-runs.md`).
...
- **AC1 (R1):** `/accounts?section=supplier-payments` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/supplier-payments.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/supplier_payments_tab.dart`
