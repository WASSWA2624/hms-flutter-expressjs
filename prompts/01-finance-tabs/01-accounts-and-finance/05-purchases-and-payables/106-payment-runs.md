# Prompt 106 — Implement Payment Runs

## Context

- **Sequence:** 106 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 105 — Supplier Adjustments (`prompts/01-finance-tabs/01-accounts-and-finance/05-purchases-and-payables/105-supplier-adjustments.md`).
...
- **AC1 (R1):** `/accounts?section=payment-runs` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/payment-runs.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/payment_runs_tab.dart`
