# Prompt 009 — Implement Integration Mappings

## Context

- **Sequence:** 009 of 159
- **Phase:** Accounts foundation — setup and controls
- **Prerequisite:** Prompt 008 — Opening Balances (`prompts/01-finance-tabs/01-accounts-and-finance/01-setup-and-controls/008-opening-balances.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 010 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=integration-mappings` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/setup-and-controls/integration-mappings.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/integration_mappings_tab.dart`
