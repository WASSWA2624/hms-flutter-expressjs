# Prompt 158 — Implement Data Exports

## Context

- **Sequence:** 158 of 159
- **Phase:** Accounts operations — audit trail
- **Prerequisite:** Prompt 157 — Reversals & Voids (`prompts/01-finance-tabs/01-accounts-and-finance/12-audit-trail/157-reversals-and-voids.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 159 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=data-exports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/audit-trail/data-exports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/data_exports_tab.dart`
