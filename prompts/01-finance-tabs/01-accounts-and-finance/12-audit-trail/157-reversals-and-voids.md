# Prompt 157 — Implement Reversals & Voids

## Context

- **Sequence:** 157 of 159
- **Phase:** Accounts operations — audit trail
- **Prerequisite:** Prompt 156 — Posting History (`prompts/01-finance-tabs/01-accounts-and-finance/12-audit-trail/156-posting-history.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 158 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=reversals-and-voids` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/audit-trail/reversals-and-voids.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/reversals_and_voids_tab.dart`
