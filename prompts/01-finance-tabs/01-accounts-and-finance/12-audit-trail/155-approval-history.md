# Prompt 155 — Implement Approval History

## Context

- **Sequence:** 155 of 159
- **Phase:** Accounts operations — audit trail
- **Prerequisite:** Prompt 154 — Transaction History (`prompts/01-finance-tabs/01-accounts-and-finance/12-audit-trail/154-transaction-history.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 156 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=approval-history` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/audit-trail/approval-history.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/approval_history_tab.dart`
