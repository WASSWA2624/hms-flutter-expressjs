# Prompt 144 — Implement Year-end Close Runs

## Context

- **Sequence:** 144 of 159
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 143 — Close History (`prompts/01-finance-tabs/01-accounts-and-finance/10-period-close/143-close-history.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 145 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=year-end-close-runs` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/period-close/year-end-close-runs.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/year_end_close_runs_tab.dart`
