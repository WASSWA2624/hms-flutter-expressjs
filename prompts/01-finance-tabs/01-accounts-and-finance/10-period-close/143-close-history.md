# Prompt 143 — Implement Close History

## Context

- **Sequence:** 143 of 159
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 142 — Reopen Requests (`prompts/01-finance-tabs/01-accounts-and-finance/10-period-close/142-reopen-requests.md`).
...
- **AC1 (R1):** `/accounts?section=close-history` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/period-close/close-history.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/close_history_tab.dart`
