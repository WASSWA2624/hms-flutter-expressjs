# Prompt 142 — Implement Reopen Requests

## Context

- **Sequence:** 142 of 159
- **Phase:** Accounts operations — period close
- **Prerequisite:** Prompt 141 — Period Adjustments (`prompts/01-finance-tabs/01-accounts-and-finance/10-period-close/141-period-adjustments.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 143 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=reopen-requests` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/period-close/reopen-requests.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/reopen_requests_tab.dart`
