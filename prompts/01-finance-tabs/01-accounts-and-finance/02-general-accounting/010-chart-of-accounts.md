# Prompt 010 — Implement Chart of Accounts

## Context

- **Sequence:** 010 of 159
- **Phase:** Accounts foundation — general accounting
- **Prerequisite:** Prompt 009 — Integration Mappings (`prompts/01-finance-tabs/01-accounts-and-finance/01-setup-and-controls/009-integration-mappings.md`).
...
- **AC1 (R1):** `/accounts?section=chart-of-accounts` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/chart-of-accounts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/chart_of_accounts_tab.dart`
