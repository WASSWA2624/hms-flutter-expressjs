# Prompt 021 — Implement General Ledger

## Context

- **Sequence:** 021 of 159
- **Phase:** Accounts foundation — books and recurring entries
- **Prerequisite:** Prompt 020 — Asset Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/020-asset-journal.md`).
- **Menu path:** `Accounts & Finance → General Accounting → General Ledger`
- **Canonical route:** `/accounts?section=general-ledger`
- **Tab profile:** `analysis` table/worklist
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 022 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/accounts?section=general-ledger` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/general-ledger.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/general_ledger_tab.dart`
