# Prompt 017 — Implement Adjustment Journal

## Context

- **Sequence:** 017 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 016 — Cash Payments Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/016-cash-payments-journal.md`).
...
- **AC1 (R1):** `/accounts?section=adjustment-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/adjustment-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/adjustment_journal_tab.dart`
