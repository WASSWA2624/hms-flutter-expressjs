# Prompt 013 — Implement Sales Journal

## Context

- **Sequence:** 013 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 012 — General Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/012-general-journal.md`).
...
- **AC1 (R1):** `/accounts?section=sales-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/sales-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/sales_journal_tab.dart`
