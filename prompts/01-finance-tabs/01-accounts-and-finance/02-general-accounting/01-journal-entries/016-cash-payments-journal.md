# Prompt 016 — Implement Cash Payments Journal

## Context

- **Sequence:** 016 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 015 — Cash Receipts Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/015-cash-receipts-journal.md`).
...
- **AC1 (R1):** `/accounts?section=cash-payments-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/cash-payments-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_payments_journal_tab.dart`
