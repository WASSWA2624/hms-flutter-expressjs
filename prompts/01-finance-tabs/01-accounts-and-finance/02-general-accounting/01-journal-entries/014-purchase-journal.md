# Prompt 014 — Implement Purchase Journal

## Context

- **Sequence:** 014 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 013 — Sales Journal (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/013-sales-journal.md`).
...
- **AC1 (R1):** `/accounts?section=purchase-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/purchase-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/purchase_journal_tab.dart`
