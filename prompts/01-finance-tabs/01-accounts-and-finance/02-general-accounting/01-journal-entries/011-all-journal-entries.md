# Prompt 011 — Implement All Journal Entries

## Context

- **Sequence:** 011 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 010 — Chart of Accounts (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/010-chart-of-accounts.md`).
...
- **AC1 (R1):** `/accounts?section=all-journal-entries` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/all-journal-entries.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/all_journal_entries_tab.dart`
