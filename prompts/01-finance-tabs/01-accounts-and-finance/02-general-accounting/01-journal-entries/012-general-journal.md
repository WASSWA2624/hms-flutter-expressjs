# Prompt 012 — Implement General Journal

## Context

- **Sequence:** 012 of 159
- **Phase:** Accounts foundation — journal entries
- **Prerequisite:** Prompt 011 — All Journal Entries (`prompts/01-finance-tabs/01-accounts-and-finance/02-general-accounting/01-journal-entries/011-all-journal-entries.md`).
...
- **AC1 (R1):** `/accounts?section=general-journal` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/general-accounting/journal-entries/general-journal.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/general_journal_tab.dart`
