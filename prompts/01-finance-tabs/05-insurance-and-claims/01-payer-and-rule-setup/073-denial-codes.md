# Prompt 073 — Implement Denial Codes

## Context

- **Sequence:** 073 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 072 — Required Documents (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/072-required-documents.md`).
...
- **AC1 (R1):** `/claims?section=denial-codes` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/denial-codes.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/denial_codes_tab.dart`
