# Prompt 066 — Implement Corporate Payers

## Context

- **Sequence:** 066 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 065 — Insurance Providers (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/065-insurance-providers.md`).
...
- **AC1 (R1):** `/claims?section=corporate-payers` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/corporate-payers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/corporate_payers_tab.dart`
