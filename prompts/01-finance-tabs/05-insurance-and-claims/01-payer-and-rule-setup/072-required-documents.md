# Prompt 072 — Implement Required Documents

## Context

- **Sequence:** 072 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 071 — Exclusions & Limits (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/071-exclusions-and-limits.md`).
...
- **AC1 (R1):** `/claims?section=required-documents` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/required-documents.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/required_documents_tab.dart`
