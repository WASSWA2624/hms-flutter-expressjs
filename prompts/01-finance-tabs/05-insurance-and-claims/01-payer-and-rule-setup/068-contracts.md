# Prompt 068 — Implement Contracts

## Context

- **Sequence:** 068 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 067 — Plans & Products (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/067-plans-and-products.md`).
...
- **AC1 (R1):** `/claims?section=contracts` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/contracts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/contracts_tab.dart`
