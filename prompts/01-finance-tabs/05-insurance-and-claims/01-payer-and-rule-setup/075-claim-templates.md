# Prompt 075 — Implement Claim Templates

## Context

- **Sequence:** 075 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 074 — Submission Channels (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/074-submission-channels.md`).
...
- **AC1 (R1):** `/claims?section=claim-templates` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claim-templates.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claim_templates_tab.dart`
