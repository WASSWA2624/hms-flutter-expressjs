# Prompt 067 — Implement Plans & Products

## Context

- **Sequence:** 067 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 066 — Corporate Payers (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/066-corporate-payers.md`).
...
- **AC1 (R1):** `/claims?section=plans-and-products` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/plans-and-products.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/plans_and_products_tab.dart`
