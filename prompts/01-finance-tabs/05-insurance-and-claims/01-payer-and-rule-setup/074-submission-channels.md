# Prompt 074 — Implement Submission Channels

## Context

- **Sequence:** 074 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 073 — Denial Codes (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/073-denial-codes.md`).
...
- **AC1 (R1):** `/claims?section=submission-channels` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/submission-channels.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/submission_channels_tab.dart`
