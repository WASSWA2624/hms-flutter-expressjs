# Prompt 071 — Implement Exclusions & Limits

## Context

- **Sequence:** 071 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 070 — Coverage Rules (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/070-coverage-rules.md`).
...
- **AC1 (R1):** `/claims?section=exclusions-and-limits` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/exclusions-and-limits.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/exclusions_and_limits_tab.dart`
