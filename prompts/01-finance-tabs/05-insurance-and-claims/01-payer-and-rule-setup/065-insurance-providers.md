# Prompt 065 — Implement Insurance Providers

## Context

- **Sequence:** 065 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 064 — Billing Reports (`prompts/01-finance-tabs/04-billing-collections/064-billing-reports.md`).
...
- **AC1 (R1):** `/claims?section=insurance-providers` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/insurance-providers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/insurance_providers_tab.dart`
