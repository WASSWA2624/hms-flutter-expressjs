# Prompt 076 — Implement Claim Rules

## Context

- **Sequence:** 076 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 075 — Claim Templates (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/075-claim-templates.md`).
...
- **AC1 (R1):** `/claims?section=claim-rules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claim-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claim_rules_tab.dart`
