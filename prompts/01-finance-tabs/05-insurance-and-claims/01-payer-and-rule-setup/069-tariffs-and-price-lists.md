# Prompt 069 — Implement Tariffs & Price Lists

## Context

- **Sequence:** 069 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 068 — Contracts (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/068-contracts.md`).
...
- **AC1 (R1):** `/claims?section=tariffs-and-price-lists` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/tariffs-and-price-lists.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/tariffs_and_price_lists_tab.dart`
