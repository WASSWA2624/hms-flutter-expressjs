# Prompt 070 — Implement Coverage Rules

## Context

- **Sequence:** 070 of 159
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 069 — Tariffs & Price Lists (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/069-tariffs-and-price-lists.md`).
...
- **AC1 (R1):** `/claims?section=coverage-rules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/coverage-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/coverage_rules_tab.dart`
