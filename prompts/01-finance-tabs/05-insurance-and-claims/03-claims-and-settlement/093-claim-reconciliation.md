# Prompt 093 — Implement Claim Reconciliation

## Context

- **Sequence:** 093 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 092 — Payer Balances (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/092-payer-balances.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 094 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/claims?section=claim-reconciliation` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claim-reconciliation.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claim_reconciliation_tab.dart`
