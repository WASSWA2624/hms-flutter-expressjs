# Prompt 094 — Implement Payer Statements

## Context

- **Sequence:** 094 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 093 — Claim Reconciliation (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/093-claim-reconciliation.md`).
...
- **AC1 (R1):** `/claims?section=payer-statements` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/payer-statements.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/payer_statements_tab.dart`
