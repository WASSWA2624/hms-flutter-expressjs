# Prompt 099 — Implement Insurance Reports

## Context

- **Sequence:** 099 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 098 — Overview (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/098-overview.md`).
...
- **AC1 (R1):** `/claims?section=insurance-reports` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/insurance-reports.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/insurance_reports_tab.dart`
