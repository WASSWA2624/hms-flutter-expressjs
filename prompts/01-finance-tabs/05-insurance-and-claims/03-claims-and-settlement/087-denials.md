# Prompt 087 — Implement Denials

## Context

- **Sequence:** 087 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 086 — Adjudications (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/086-adjudications.md`).
...
- **AC1 (R1):** `/claims?section=denials` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/denials.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/denials_tab.dart`
