# Prompt 083 — Implement Claim Validations

## Context

- **Sequence:** 083 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 082 — Claims (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/082-claims.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 084 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/claims?section=claim-validations` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claim-validations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claim_validations_tab.dart`
