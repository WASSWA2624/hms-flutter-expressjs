# Prompt 091 — Implement Remittance Allocations

## Context

- **Sequence:** 091 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 090 — Insurer Payments (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/090-insurer-payments.md`).
...
- **AC1 (R1):** `/claims?section=remittance-allocations` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/remittance-allocations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/remittance_allocations_tab.dart`
