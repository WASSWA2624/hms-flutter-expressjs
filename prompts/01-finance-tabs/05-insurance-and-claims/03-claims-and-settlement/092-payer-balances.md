# Prompt 092 — Implement Payer Balances

## Context

- **Sequence:** 092 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 091 — Remittance Allocations (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/091-remittance-allocations.md`).
...
- **AC1 (R1):** `/claims?section=payer-balances` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/payer-balances.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/payer_balances_tab.dart`
