# Prompt 095 — Implement Claims Aging

## Context

- **Sequence:** 095 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 094 — Payer Statements (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/094-payer-statements.md`).
...
- **AC1 (R1):** `/claims?section=claims-aging` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claims-aging.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claims_aging_tab.dart`
