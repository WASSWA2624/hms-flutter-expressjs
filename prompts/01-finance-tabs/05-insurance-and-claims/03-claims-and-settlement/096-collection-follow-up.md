# Prompt 096 — Implement Collection Follow-up

## Context

- **Sequence:** 096 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 095 — Claims Aging (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/095-claims-aging.md`).
...
- **AC1 (R1):** `/claims?section=collection-follow-up` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/collection-follow-up.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/collection_follow_up_tab.dart`
