# Prompt 097 — Implement Disputes

## Context

- **Sequence:** 097 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 096 — Collection Follow-up (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/096-collection-follow-up.md`).
...
- **AC1 (R1):** `/claims?section=disputes` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/disputes.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/disputes_tab.dart`
