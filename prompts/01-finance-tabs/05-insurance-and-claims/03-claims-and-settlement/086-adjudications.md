# Prompt 086 — Implement Adjudications

## Context

- **Sequence:** 086 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 085 — Claim Submissions (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/085-claim-submissions.md`).
...
- **AC1 (R1):** `/claims?section=adjudications` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/adjudications.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/adjudications_tab.dart`
