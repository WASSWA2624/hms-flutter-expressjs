# Prompt 082 — Implement Claims

## Context

- **Sequence:** 082 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 081 — Pre-authorizations (`prompts/01-finance-tabs/05-insurance-and-claims/02-membership-and-authorization/081-pre-authorizations.md`).
...
- **AC1 (R1):** `/claims?section=claims` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claims.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claims_tab.dart`
