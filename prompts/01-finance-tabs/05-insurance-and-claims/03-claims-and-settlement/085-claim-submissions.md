# Prompt 085 — Implement Claim Submissions

## Context

- **Sequence:** 085 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 084 — Claim Batches (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/084-claim-batches.md`).
...
- **AC1 (R1):** `/claims?section=claim-submissions` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/claim-submissions.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/claim_submissions_tab.dart`
