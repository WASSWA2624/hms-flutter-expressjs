# Prompt 088 — Implement Resubmissions & Appeals

## Context

- **Sequence:** 088 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 087 — Denials (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/087-denials.md`).
...
- **AC1 (R1):** `/claims?section=resubmissions-and-appeals` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/resubmissions-and-appeals.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/resubmissions_and_appeals_tab.dart`
