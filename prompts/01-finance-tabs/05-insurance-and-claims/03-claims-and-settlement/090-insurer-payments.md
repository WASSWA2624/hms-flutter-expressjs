# Prompt 090 — Implement Insurer Payments

## Context

- **Sequence:** 090 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 089 — Remittance Advice (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/089-remittance-advice.md`).
...
- **AC1 (R1):** `/claims?section=insurer-payments` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/insurer-payments.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/insurer_payments_tab.dart`
