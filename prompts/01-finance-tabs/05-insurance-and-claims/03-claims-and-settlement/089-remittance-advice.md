# Prompt 089 — Implement Remittance Advice

## Context

- **Sequence:** 089 of 159
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 088 — Resubmissions & Appeals (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/088-resubmissions-and-appeals.md`).
...
- **AC1 (R1):** `/claims?section=remittance-advice` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/remittance-advice.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/remittance_advice_tab.dart`
