# Prompt 078 — Implement Members & Dependants

## Context

- **Sequence:** 078 of 159
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 077 — Patient Policies (`prompts/01-finance-tabs/05-insurance-and-claims/02-membership-and-authorization/077-patient-policies.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 079 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/claims?section=members-and-dependants` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/members-and-dependants.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/members_and_dependants_tab.dart`
