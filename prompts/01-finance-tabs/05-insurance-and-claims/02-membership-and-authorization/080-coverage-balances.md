# Prompt 080 — Implement Coverage Balances

## Context

- **Sequence:** 080 of 159
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 079 — Eligibility Checks (`prompts/01-finance-tabs/05-insurance-and-claims/02-membership-and-authorization/079-eligibility-checks.md`).
...
- **AC1 (R1):** `/claims?section=coverage-balances` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/coverage-balances.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/coverage_balances_tab.dart`
