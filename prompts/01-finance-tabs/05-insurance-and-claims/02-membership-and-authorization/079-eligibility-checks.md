# Prompt 079 — Implement Eligibility Checks

## Context

- **Sequence:** 079 of 159
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 078 — Members & Dependants (`prompts/01-finance-tabs/05-insurance-and-claims/02-membership-and-authorization/078-members-and-dependants.md`).
...
- **AC1 (R1):** `/claims?section=eligibility-checks` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/eligibility-checks.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/eligibility_checks_tab.dart`
