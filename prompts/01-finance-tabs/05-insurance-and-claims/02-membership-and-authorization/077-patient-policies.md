# Prompt 077 — Implement Patient Policies

## Context

- **Sequence:** 077 of 159
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 076 — Claim Rules (`prompts/01-finance-tabs/05-insurance-and-claims/01-payer-and-rule-setup/076-claim-rules.md`).
...
- **AC1 (R1):** `/claims?section=patient-policies` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/patient-policies.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/patient_policies_tab.dart`
