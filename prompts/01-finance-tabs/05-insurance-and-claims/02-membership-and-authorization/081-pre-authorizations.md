# Prompt 081 — Implement Pre-authorizations

## Context

- **Sequence:** 081 of 159
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 080 — Coverage Balances (`prompts/01-finance-tabs/05-insurance-and-claims/02-membership-and-authorization/080-coverage-balances.md`).
...
- **AC1 (R1):** `/claims?section=pre-authorizations` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/insurance-and-claims/pre-authorizations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/claims/presentation/widgets/pre_authorizations_tab.dart`
