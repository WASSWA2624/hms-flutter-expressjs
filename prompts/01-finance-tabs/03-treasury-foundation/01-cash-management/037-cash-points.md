# Prompt 037 — Implement Cash Points

## Context

- **Sequence:** 037 of 159
- **Phase:** Treasury foundation — cash management
- **Prerequisite:** Prompt 036 — Debit Notes (`prompts/01-finance-tabs/02-billing-foundation/036-debit-notes.md`).
...
- **AC1 (R1):** `/accounts?section=cash-points` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/cash-management/cash-points.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/cash_points_tab.dart`
