# Prompt 026 — Implement Packages & Bundles

## Context

- **Sequence:** 026 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 025 — Price Lists & Tariffs (`prompts/01-finance-tabs/02-billing-foundation/025-price-lists-and-tariffs.md`).
...
- **AC1 (R1):** `/billing?section=packages-and-bundles` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/packages-and-bundles.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/packages_and_bundles_tab.dart`
