# Prompt 033 — Implement Estimates & Quotations

## Context

- **Sequence:** 033 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 032 — Unbilled Charges (`prompts/01-finance-tabs/02-billing-foundation/032-unbilled-charges.md`).
...
- **AC1 (R1):** `/billing?section=estimates-and-quotations` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/estimates-and-quotations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/estimates_and_quotations_tab.dart`
