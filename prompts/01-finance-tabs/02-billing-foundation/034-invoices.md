# Prompt 034 — Implement Invoices

## Context

- **Sequence:** 034 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 033 — Estimates & Quotations (`prompts/01-finance-tabs/02-billing-foundation/033-estimates-and-quotations.md`).
...
- **AC1 (R1):** `/billing?section=invoices` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/invoices.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/invoices_tab.dart`
