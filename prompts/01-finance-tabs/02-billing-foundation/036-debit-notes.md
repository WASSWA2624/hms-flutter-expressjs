# Prompt 036 — Implement Debit Notes

## Context

- **Sequence:** 036 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 035 — Credit Notes (`prompts/01-finance-tabs/02-billing-foundation/035-credit-notes.md`).
...
- **AC1 (R1):** `/billing?section=debit-notes` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/debit-notes.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/debit_notes_tab.dart`
