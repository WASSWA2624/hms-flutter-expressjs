# Prompt 035 — Implement Credit Notes

## Context

- **Sequence:** 035 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 034 — Invoices (`prompts/01-finance-tabs/02-billing-foundation/034-invoices.md`).
...
- **AC1 (R1):** `/billing?section=credit-notes` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/credit-notes.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/credit_notes_tab.dart`
