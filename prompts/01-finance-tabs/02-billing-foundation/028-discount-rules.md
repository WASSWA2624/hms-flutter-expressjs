# Prompt 028 — Implement Discount Rules

## Context

- **Sequence:** 028 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 027 — Billing Rules (`prompts/01-finance-tabs/02-billing-foundation/027-billing-rules.md`).
...
- **AC1 (R1):** `/billing?section=discount-rules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/discount-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/discount_rules_tab.dart`
