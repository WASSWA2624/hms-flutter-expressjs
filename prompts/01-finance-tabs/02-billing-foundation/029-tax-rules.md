# Prompt 029 — Implement Tax Rules

## Context

- **Sequence:** 029 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 028 — Discount Rules (`prompts/01-finance-tabs/02-billing-foundation/028-discount-rules.md`).
...
- **AC1 (R1):** `/billing?section=tax-rules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/tax-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/tax_rules_tab.dart`
