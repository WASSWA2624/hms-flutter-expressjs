# Prompt 030 — Implement Document Templates

## Context

- **Sequence:** 030 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 029 — Tax Rules (`prompts/01-finance-tabs/02-billing-foundation/029-tax-rules.md`).
...
10. **Add and run verification.**
    ...
    - Do not proceed to Prompt 031 until all acceptance criteria below pass.
...
- **AC1 (R1):** `/billing?section=document-templates` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/document-templates.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/document_templates_tab.dart`
