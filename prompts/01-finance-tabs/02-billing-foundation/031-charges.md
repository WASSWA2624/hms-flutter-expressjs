# Prompt 031 — Implement Charges

## Context

- **Sequence:** 031 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 030 — Document Templates (`prompts/01-finance-tabs/02-billing-foundation/030-document-templates.md`).
...
- **AC1 (R1):** `/billing?section=charges` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/charges.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/charges_tab.dart`
