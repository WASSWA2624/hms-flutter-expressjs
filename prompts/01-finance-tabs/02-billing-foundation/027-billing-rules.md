# Prompt 027 — Implement Billing Rules

## Context

- **Sequence:** 027 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 026 — Packages & Bundles (`prompts/01-finance-tabs/02-billing-foundation/026-packages-and-bundles.md`).
...
- **AC1 (R1):** `/billing?section=billing-rules` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/billing-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/billing_rules_tab.dart`
