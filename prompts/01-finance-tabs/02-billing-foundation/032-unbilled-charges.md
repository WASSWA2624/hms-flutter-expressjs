# Prompt 032 — Implement Unbilled Charges

## Context

- **Sequence:** 032 of 159
- **Phase:** Billing foundation — configuration and revenue documents
- **Prerequisite:** Prompt 031 — Charges (`prompts/01-finance-tabs/02-billing-foundation/031-charges.md`).
...
- **AC1 (R1):** `/billing?section=unbilled-charges` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/billing/unbilled-charges.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/billing/presentation/widgets/unbilled_charges_tab.dart`
