# Prompt 100 — Implement Suppliers

## Context

- **Sequence:** 100 of 159
- **Phase:** Accounts operations — purchases and payables
- **Prerequisite:** Prompt 099 — Insurance Reports (`prompts/01-finance-tabs/05-insurance-and-claims/03-claims-and-settlement/099-insurance-reports.md`).
...
- **AC1 (R1):** `/accounts?section=suppliers` opens the correct authorized tab, restores state, and omits it when access is denied.
- **AC2 (R2):** All API operations in `.cursor/finance/accounts-and-finance/purchases-and-payables/suppliers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `frontend/lib/features/accounts/presentation/widgets/suppliers_tab.dart`
