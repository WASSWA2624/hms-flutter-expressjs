...
- **Prerequisite:** Prompt 011 — All Journal Entries (`prompts/01-finance-tabs/01-accounts-foundation/02-general-accounting/01-journal-entries/011-all-journal-entries.md`).
