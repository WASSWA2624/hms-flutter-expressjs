# Prompt 068 — Implement Tariffs & Price Lists

## Context

- **Sequence:** 068 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 067 — Contracts (`prompts/03-insurance-and-claims/067-contracts.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 069 until all acceptance criteria below pass.
