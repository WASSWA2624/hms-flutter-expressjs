# Prompt 091 — Implement Payer Balances

## Context

- **Sequence:** 091 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 090 — Remittance Allocations (`prompts/03-insurance-and-claims/090-remittance-allocations.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 092 until all acceptance criteria below pass.
