# Prompt 087 — Implement Resubmissions & Appeals

## Context

- **Sequence:** 087 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 086 — Denials (`prompts/03-insurance-and-claims/086-denials.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 088 until all acceptance criteria below pass.
