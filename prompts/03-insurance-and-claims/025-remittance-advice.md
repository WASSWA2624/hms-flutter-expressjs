# Prompt 025 — Implement Remittance Advice

## Context

- **Sequence:** 025 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 148 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** `Insurance & Claims → Resubmissions & Appeals` (`prompts/03-insurance-and-claims/024-resubmissions-and-appeals.md`).
- **Menu path:** `Insurance & Claims → Remittance Advice`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/remittance-advice.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/remittance-advice.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/remittance-advice.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Insurer Payments` (`prompts/03-insurance-and-claims/026-insurer-payments.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/remittance-advice.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/remittance-advice.md`
