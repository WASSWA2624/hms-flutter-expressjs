# Prompt 094 — Implement Claims Aging

## Context

- **Sequence:** 094 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 093 — Payer Statements (`prompts/03-insurance-and-claims/093-payer-statements.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 095 until all acceptance criteria below pass.
