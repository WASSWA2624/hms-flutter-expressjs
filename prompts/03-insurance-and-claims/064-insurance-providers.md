# Prompt 064 — Implement Insurance Providers

## Context

- **Sequence:** 064 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 063 — Billing Reports (`prompts/02-billing/063-billing-reports.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 065 until all acceptance criteria below pass.
