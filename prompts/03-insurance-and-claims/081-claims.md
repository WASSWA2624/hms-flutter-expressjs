# Prompt 081 — Implement Claims

## Context

- **Sequence:** 081 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 080 — Pre-authorizations (`prompts/03-insurance-and-claims/080-pre-authorizations.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 082 until all acceptance criteria below pass.
