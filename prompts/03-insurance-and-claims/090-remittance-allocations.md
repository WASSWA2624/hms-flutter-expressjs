# Prompt 090 — Implement Remittance Allocations

## Context

- **Sequence:** 090 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 089 — Insurer Payments (`prompts/03-insurance-and-claims/089-insurer-payments.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 091 until all acceptance criteria below pass.
