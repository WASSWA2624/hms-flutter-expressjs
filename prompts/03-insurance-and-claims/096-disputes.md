# Prompt 096 — Implement Disputes

## Context

- **Sequence:** 096 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 095 — Collection Follow-up (`prompts/03-insurance-and-claims/095-collection-follow-up.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 097 until all acceptance criteria below pass.
