# Prompt 020 — Implement Claim Batches

## Context

- **Sequence:** 020 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 143 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** `Insurance & Claims → Claim Validations` (`prompts/03-insurance-and-claims/019-claim-validations.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Claim Submissions` (`prompts/03-insurance-and-claims/021-claim-submissions.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/claim-batches.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
