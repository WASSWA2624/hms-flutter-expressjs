# Prompt 075 — Implement Claim Rules

## Context

- **Sequence:** 075 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 074 — Claim Templates (`prompts/03-insurance-and-claims/074-claim-templates.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 076 until all acceptance criteria below pass.
