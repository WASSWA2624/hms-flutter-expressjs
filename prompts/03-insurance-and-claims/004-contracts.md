...
- **Sequence:** 004 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 127 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** `Insurance & Claims → Plans & Products` (`prompts/03-insurance-and-claims/003-plans-and-products.md`).
- **Menu path:** `Insurance & Claims → Contracts`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/contracts.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/contracts.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/contracts.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Tariffs & Price Lists` (`prompts/03-insurance-and-claims/005-tariffs-and-price-lists.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/contracts.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/contracts.md`
