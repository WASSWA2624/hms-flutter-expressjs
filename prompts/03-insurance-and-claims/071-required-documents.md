# Prompt 071 — Implement Required Documents

## Context

- **Sequence:** 071 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 070 — Exclusions & Limits (`prompts/03-insurance-and-claims/070-exclusions-and-limits.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 072 until all acceptance criteria below pass.
