# Prompt 074 — Implement Claim Templates

## Context

- **Sequence:** 074 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 073 — Submission Channels (`prompts/03-insurance-and-claims/073-submission-channels.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 075 until all acceptance criteria below pass.
