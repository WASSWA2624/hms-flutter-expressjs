# Prompt 092 — Implement Claim Reconciliation

## Context

- **Sequence:** 092 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 091 — Payer Balances (`prompts/03-insurance-and-claims/091-payer-balances.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 093 until all acceptance criteria below pass.
