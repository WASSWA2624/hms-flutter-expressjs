# Prompt 089 — Implement Insurer Payments

## Context

- **Sequence:** 089 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 088 — Remittance Advice (`prompts/03-insurance-and-claims/088-remittance-advice.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 090 until all acceptance criteria below pass.
