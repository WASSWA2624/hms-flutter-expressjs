# Prompt 085 — Implement Adjudications

## Context

- **Sequence:** 085 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 084 — Claim Submissions (`prompts/03-insurance-and-claims/084-claim-submissions.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 086 until all acceptance criteria below pass.
