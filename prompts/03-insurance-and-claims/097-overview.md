# Prompt 097 — Implement Overview

## Context

- **Sequence:** 097 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 096 — Disputes (`prompts/03-insurance-and-claims/096-disputes.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 098 until all acceptance criteria below pass.
