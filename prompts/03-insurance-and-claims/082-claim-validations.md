# Prompt 082 — Implement Claim Validations

## Context

- **Sequence:** 082 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 081 — Claims (`prompts/03-insurance-and-claims/081-claims.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 083 until all acceptance criteria below pass.
