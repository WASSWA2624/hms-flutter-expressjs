# Prompt 077 — Implement Members & Dependants

## Context

- **Sequence:** 077 of 158
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 076 — Patient Policies (`prompts/03-insurance-and-claims/076-patient-policies.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 078 until all acceptance criteria below pass.
