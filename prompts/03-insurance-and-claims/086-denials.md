# Prompt 086 — Implement Denials

## Context

- **Sequence:** 086 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 085 — Adjudications (`prompts/03-insurance-and-claims/085-adjudications.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 087 until all acceptance criteria below pass.
