# Prompt 007 — Implement Exclusions & Limits

## Context

- **Sequence:** 007 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 130 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** `Insurance & Claims → Coverage Rules` (`prompts/03-insurance-and-claims/006-coverage-rules.md`).
- **Menu path:** `Insurance & Claims → Exclusions & Limits`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/exclusions-and-limits.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/exclusions-and-limits.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/exclusions-and-limits.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Required Documents` (`prompts/03-insurance-and-claims/008-required-documents.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/exclusions-and-limits.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/exclusions-and-limits.md`
