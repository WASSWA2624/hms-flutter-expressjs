# Prompt 079 — Implement Coverage Balances

## Context

- **Sequence:** 079 of 158
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 078 — Eligibility Checks (`prompts/03-insurance-and-claims/078-eligibility-checks.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 080 until all acceptance criteria below pass.
