# Prompt 080 — Implement Pre-authorizations

## Context

- **Sequence:** 080 of 158
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 079 — Coverage Balances (`prompts/03-insurance-and-claims/079-coverage-balances.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 081 until all acceptance criteria below pass.
