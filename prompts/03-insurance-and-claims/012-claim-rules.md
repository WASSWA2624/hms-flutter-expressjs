# Prompt 012 — Implement Claim Rules

## Context

- **Sequence:** 012 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 135 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** `Insurance & Claims → Claim Templates` (`prompts/03-insurance-and-claims/011-claim-templates.md`).
- **Menu path:** `Insurance & Claims → Claim Rules`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/claim-rules.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/claim-rules.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/claim-rules.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Patient Policies` (`prompts/03-insurance-and-claims/013-patient-policies.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/claim-rules.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/claim-rules.md`
