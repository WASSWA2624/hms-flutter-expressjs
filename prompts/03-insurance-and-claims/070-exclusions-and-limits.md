# Prompt 070 — Implement Exclusions & Limits

## Context

- **Sequence:** 070 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 069 — Coverage Rules (`prompts/03-insurance-and-claims/069-coverage-rules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 071 until all acceptance criteria below pass.
