# Prompt 069 — Implement Coverage Rules

## Context

- **Sequence:** 069 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 068 — Tariffs & Price Lists (`prompts/03-insurance-and-claims/068-tariffs-and-price-lists.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 070 until all acceptance criteria below pass.
