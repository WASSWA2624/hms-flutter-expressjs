# Prompt 066 — Implement Plans & Products

## Context

- **Sequence:** 066 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 065 — Corporate Payers (`prompts/03-insurance-and-claims/065-corporate-payers.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 067 until all acceptance criteria below pass.
