# Prompt 073 — Implement Submission Channels

## Context

- **Sequence:** 073 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 072 — Denial Codes (`prompts/03-insurance-and-claims/072-denial-codes.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 074 until all acceptance criteria below pass.
