# Prompt 076 — Implement Patient Policies

## Context

- **Sequence:** 076 of 158
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** Prompt 075 — Claim Rules (`prompts/03-insurance-and-claims/075-claim-rules.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 077 until all acceptance criteria below pass.
