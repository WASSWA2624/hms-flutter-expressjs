...
- **Sequence:** 002 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 125 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** `Insurance & Claims → Insurance Providers` (`prompts/03-insurance-and-claims/001-insurance-providers.md`).
- **Menu path:** `Insurance & Claims → Corporate Payers`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/corporate-payers.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/corporate-payers.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/corporate-payers.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Plans & Products` (`prompts/03-insurance-and-claims/003-plans-and-products.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/corporate-payers.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/corporate-payers.md`
