# Prompt 065 — Implement Corporate Payers

## Context

- **Sequence:** 065 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 064 — Insurance Providers (`prompts/03-insurance-and-claims/064-insurance-providers.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 066 until all acceptance criteria below pass.
