# Prompt 067 — Implement Contracts

## Context

- **Sequence:** 067 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 066 — Plans & Products (`prompts/03-insurance-and-claims/066-plans-and-products.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 068 until all acceptance criteria below pass.
