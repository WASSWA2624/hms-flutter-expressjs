# Prompt 013 — Implement Patient Policies

## Context

- **Sequence:** 013 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 136 of 158
- **Phase:** Insurance and claims — membership and authorization
- **Prerequisite:** `Insurance & Claims → Claim Rules` (`prompts/03-insurance-and-claims/012-claim-rules.md`).
- **Menu path:** `Insurance & Claims → Patient Policies`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/patient-policies.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/patient-policies.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/patient-policies.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Members & Dependants` (`prompts/03-insurance-and-claims/014-members-and-dependants.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/patient-policies.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/patient-policies.md`
