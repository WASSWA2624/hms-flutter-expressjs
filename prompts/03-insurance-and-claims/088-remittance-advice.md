# Prompt 088 — Implement Remittance Advice

## Context

- **Sequence:** 088 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 087 — Resubmissions & Appeals (`prompts/03-insurance-and-claims/087-resubmissions-and-appeals.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 089 until all acceptance criteria below pass.
