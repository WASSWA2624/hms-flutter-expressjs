# Prompt 072 — Implement Denial Codes

## Context

- **Sequence:** 072 of 158
- **Phase:** Insurance and claims — payer and rule setup
- **Prerequisite:** Prompt 071 — Required Documents (`prompts/03-insurance-and-claims/071-required-documents.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 073 until all acceptance criteria below pass.
