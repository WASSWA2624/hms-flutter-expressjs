# Prompt 019 — Implement Claim Validations

## Context

- **Sequence:** 019 of 035 in `prompts/03-insurance-and-claims/`
- **Overall step:** 142 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** `Insurance & Claims → Claims` (`prompts/03-insurance-and-claims/018-claims.md`).
- **Menu path:** `Insurance & Claims → Claim Validations`
...
- **Authoritative tab specification:** `.cursor/finance/insurance-and-claims/claim-validations.md`
...
3. **Implement the backend and data contract.**
   - Implement every list, detail, CRUD, workflow, report, or reconciliation operation defined under **Target API contract** in `.cursor/finance/insurance-and-claims/claim-validations.md`.
...
4. **Build the primary table with the exact source columns.**
   ...
   - Preserve this source order in Settings/export while applying the default/optional visibility defined in `.cursor/finance/insurance-and-claims/claim-validations.md`:
...
11. **Add and run verification.**
    ...
    - Do not proceed to `Insurance & Claims → Claim Batches` (`prompts/03-insurance-and-claims/020-claim-batches.md`) until all acceptance criteria below pass.
...
- **AC3 (R3):** All API operations in `.cursor/finance/insurance-and-claims/claim-validations.md` use validated, scoped, versioned contracts and pass success, denial, conflict, rollback, and audit tests.
...
- `.cursor/finance/insurance-and-claims/claim-validations.md`
