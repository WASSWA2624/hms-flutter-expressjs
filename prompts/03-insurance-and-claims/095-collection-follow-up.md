# Prompt 095 — Implement Collection Follow-up

## Context

- **Sequence:** 095 of 158
- **Phase:** Insurance and claims — claims and settlement
- **Prerequisite:** Prompt 094 — Claims Aging (`prompts/03-insurance-and-claims/094-claims-aging.md`).
...
11. **Add and run verification.**
    ...
    - Do not proceed to Prompt 096 until all acceptance criteria below pass.
