...
- Save as `prompts/{NN}-standardize-rooms-beds-tables.md` using the next number.
  - Feature slug for this screen: `rooms-beds`
  - Example: `prompts/28-standardize-rooms-beds-tables.md`
