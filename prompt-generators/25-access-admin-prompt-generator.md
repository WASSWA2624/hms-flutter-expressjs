...
- Save as `prompts/{NN}-standardize-access-admin-tables.md` using the next number.
  - Feature slug for this screen: `access-admin`
  - Example: `prompts/28-standardize-access-admin-tables.md`
