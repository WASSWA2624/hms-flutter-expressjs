...
- [x] Handover-pending permission scan: ∩ `clinical:write` for Create/Accept handover; ∪ read; nested pharmacy; subscription strip; complementary source ∪; viewports / themes. *(widget: `nursing_handover_pending_permissions_test.dart`)*
