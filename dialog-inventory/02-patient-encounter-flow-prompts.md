...
Normative contract: [`../prompt.md`](../prompt.md).
...
| 09 | [`../prompts/09-ipd-release-bed-dialog.md`](../prompts/09-ipd-release-bed-dialog.md) | `ReleaseBedDialog` | Patient/encounter flow: Release Bed (ipd). |
