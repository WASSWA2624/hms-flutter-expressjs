...
- A non-English locale may ship only when module, error, billing, roster, and Mortuary copy are complete together.
...
- Legal and release-sensitive copy must have owner approval before rollout.
