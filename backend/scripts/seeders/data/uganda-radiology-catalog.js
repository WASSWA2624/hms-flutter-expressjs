...
const ADDITIONAL_UGANDA_RADIOLOGY_TESTS = [
  ...
  radiologyTest('mri_breast', 'MRI Breast', 'MRI-BREAST', 'MRI'),
  radiologyTest('mri_prostate', 'MRI Prostate', 'MRI-PROSTATE', 'MRI'),
  radiologyTest('mri_stroke_protocol', 'MRI Brain Stroke Protocol', 'MRI-STROKE', 'MRI'),
  radiologyTest('mammo_unilateral', 'Mammography Unilateral', 'MAMMO-UNI', 'MAMMOGRAPHY'),
  radiologyTest('mammography_screening', 'Mammography Screening Bilateral', 'MAMMO-SCREEN', 'MAMMOGRAPHY'),
  radiologyTest('nuclear_medicine_bone_scan', 'Nuclear Medicine Bone Scan', 'NM-BONE', 'NUCLEAR_MEDICINE'),
  radiologyTest('pet_ct_whole_body', 'PET-CT Whole Body', 'PET-CT-WB', 'PET'),
];
...
const RADIOLOGY_TEST_CATALOG = Object.freeze([
  ...
  ...ADDITIONAL_UGANDA_RADIOLOGY_TESTS,
]);
