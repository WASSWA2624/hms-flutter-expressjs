...
apiV1Router.use('/clinical-catalog', require('../modules/clinical-term/routes/clinical-catalog.routes'));
...
apiV1Router.use('/facility-radiology-catalog', require('../modules/facility-radiology-catalog/routes/facility-radiology-catalog.routes'));
apiV1Router.use('/facility-pharmacy-catalog', require('../modules/facility-pharmacy-catalog/routes/facility-pharmacy-catalog.routes'));
...
apiV1Router.use('/accounts', require('../modules/accounts-workspace/routes/accounts-workspace.routes'));
