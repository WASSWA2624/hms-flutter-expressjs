...
const DISPOSITION_VALUES = ['ADMIT', 'SEND_TO_PHARMACY', 'DISCHARGE', 'REFER_PHYSIOTHERAPY'];
...
const createOpdFlowSchema = z
  .object({
    ...
    coverage_plan_id: resourceFriendlyIdSchema.optional().nullable(),
    insurance_company_id: resourceFriendlyIdSchema.optional().nullable(),
...
const doctorReviewSchema = z.object({
  ...
  lab_requests: z
    .array(
      z
        .object({
          lab_test_id: labTestIdentifierSchema.optional().nullable(),
          lab_panel_id: labPanelIdentifierSchema.optional().nullable(),
