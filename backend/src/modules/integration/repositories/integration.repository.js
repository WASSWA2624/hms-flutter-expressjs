 ...
 *
 * @module modules/integration/repositories
 * @description Data access layer for integration operations.
...
/**
 * Find many integrations with pagination
 *
 ...
 *
 * @param {Object} filters - Filter criteria
 * @returns {Promise<number>} Count of integrations
 */
const count = async (filters = {}) => {
  try {
    ...
    return await prisma.integration.count({ where });
  } catch (error) {
    throw new HttpError('errors.database.unexpected', 500, [{ originalError: error.message }]);
  }
};
