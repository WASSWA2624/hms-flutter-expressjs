 ...
 * Referral repository
 *
 * @module modules/referral/repositories
 * @description Data access layer for referral operations.
 ...
 * @returns {Promise<Object|null>} Referral object or null
 */
...
/**
 * Find many referrals with pagination
 *
...
const count = async (filters = {}) => {
  try {
    ...
    return await prisma.referral.count({ where });
  } catch (error) {
    throw new HttpError('errors.database.unexpected', 500, [{ originalError: error.message }]);
  }
};
 ...
 *
 * @param {string} id - Referral ID
 * @returns {Promise<Object>} Deleted referral
 */
