 ...
 *
 * @module modules/radiology-procedure/schemas
 ...
 * Used for POST /radiology-procedures endpoint
 */
const createRadiologyProcedureSchema = z.object({
 ...
 * Used for PUT /radiology-procedures/:id endpoint
 * All fields optional for partial updates
 */
const updateRadiologyProcedureSchema = z.object({
 ...
 */
const radiologyProcedureIdParamsSchema = z.object({
 ...
 */
const listRadiologyProceduresQuerySchema = listQuerySchema.extend({
