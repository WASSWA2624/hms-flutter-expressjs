/**
 * Procedure service billing & sections coverage for Clinical Completed reopen
 * flows that call POST /procedures with request-time billing.
 */
...
describe('procedure.service billing (Clinical Completed)', () => {
  beforeEach(() => {
    jest.clearAllMocks();
