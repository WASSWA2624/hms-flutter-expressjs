const subject = require('@routes/pharmacy-order/pharmacy-order.routes');

describe('pharmacy-order.routes contract', () => {
  ...
  it('registers the expected pharmacy order endpoints and methods', () => {
