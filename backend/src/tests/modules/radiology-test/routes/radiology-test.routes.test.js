...
describe('radiology-test.routes contract', () => {
  beforeEach(() => {
    jest.resetModules();
    jest.clearAllMocks();
  });
  ...
  it('exports an express router with registered handlers', () => {
    const subject = require('@routes/radiology-test/radiology-test.routes');
  ...
  it('authorizes create, update, and delete with radiology catalog write scopes', () => {
    ...
    require('@routes/radiology-test/radiology-test.routes');
