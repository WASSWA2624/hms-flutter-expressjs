const subject = require('@modules/patient-allergy/routes/patient-allergy.routes');

describe('patient-allergy.routes contract', () => {
  ...
  it('registers the expected patient allergy endpoints and methods', () => {
