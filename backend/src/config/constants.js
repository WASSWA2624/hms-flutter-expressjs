...
// AI utilities (provider-agnostic; Ollama is the v1 adapter)
const AI_PROVIDER_ALLOWLIST = Object.freeze(['ollama']);
const AI_DEFAULT_PROVIDER = 'ollama';
const AI_DEFAULT_BASE_URL = 'http://127.0.0.1:11434';
const AI_DEFAULT_MODEL = 'llama3.2:3b';
const AI_DEFAULT_TIMEOUT_MS = 8000;
const AI_DEFAULT_CLINICAL_NOTE_FORMAT_TIMEOUT_MS = 90000;
const AI_DEFAULT_DRUG_PACK_EXTRACT_TIMEOUT_MS = 90000;
const AI_DEFAULT_MAX_INPUT_CHARS = 4000;
const AI_DEFAULT_TEMPERATURE = 0;
const AI_STATUS_PROBE_TIMEOUT_MS = 2000;
const AI_JSON_BODY_LIMIT = '8mb';
const AI_MAX_PACK_IMAGES = 4;
const AI_MAX_IMAGE_BASE64_CHARS = 1400000;
