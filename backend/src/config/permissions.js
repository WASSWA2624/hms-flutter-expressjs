...
const BASE_ROLE_PERMISSIONS = {
  ...
  // Doctor shell: Dashboard, Patients, OPD, IPD, ICU, Clinical, Theater,
  // Reports, Settings. Nursing is a nurse/ward destination — not a doctor
  // top-level menu. Lab / radiology / pharmacy / discharge stay nested via
  // Clinical/OPD/IPD rather than top-level nav.
  [ROLES.DOCTOR]: [
    PERMISSIONS.CLINICAL_READ,
    PERMISSIONS.CLINICAL_WRITE,
    PERMISSIONS.COMMUNICATIONS_READ,
  ...
  // Outpatient clinician — OPD + clinical charting without inpatient/ICU/theatre shell.
  [ROLES.OPD_DOCTOR]: [
    PERMISSIONS.CLINICAL_READ,
    PERMISSIONS.CLINICAL_WRITE,
    PERMISSIONS.COMMUNICATIONS_READ,
  ...
  // Critical-care clinician — ICU/IPD focus without OPD/theatre destinations.
  [ROLES.ICU_DOCTOR]: [
    PERMISSIONS.CLINICAL_READ,
    PERMISSIONS.CLINICAL_WRITE,
    PERMISSIONS.COMMUNICATIONS_READ,
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  // Surgical clinician — inpatient + theatre focus (no OPD shell).
  [ROLES.SURGEON]: [
    PERMISSIONS.CLINICAL_READ,
    PERMISSIONS.CLINICAL_WRITE,
    PERMISSIONS.COMMUNICATIONS_READ,
  ...
  // Anaesthesia — theatre + critical care support.
  ...
  // Emergency physician — ED + clinical without theatre destination.
  ...
  // Charge nurse — bedside nursing plus limited unit/roster oversight.
  [ROLES.CHARGE_NURSE]: [
    ...(BASE_ROLE_PERMISSIONS[ROLES.NURSE] || []),
    PERMISSIONS.UNIT_READ,
    PERMISSIONS.ROSTER_READ,
    PERMISSIONS.ROSTER_WRITE,
  ],
  // Pharmacy tech — dispense assist; no pricing or pharmacy write.
  ...
  // Medical coder — coding/claims review without cashier financial approve.
  [ROLES.MEDICAL_CODER]: [
    PERMISSIONS.BILLING_READ,
    PERMISSIONS.CLAIMS_READ,
    PERMISSIONS.PATIENT_READ,
  ...
  // EMT — emergency transport ops (narrower than paramedic).
  [ROLES.EMT]: [
    PERMISSIONS.PROFILE_READ,
    PERMISSIONS.COMMUNICATIONS_READ,
    PERMISSIONS.COMMUNICATIONS_WRITE,
