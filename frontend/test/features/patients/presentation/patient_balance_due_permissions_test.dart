  ...
  group('PatientBalanceDueAtomPermissions reuse (AC1, AC4)', () {
    ...
    test(
      ...
      () {
        ...
        final AppAccessPolicy billingOnly = _tabReadPolicy();
        expect(
          PatientBalanceDueAtomPermissions.viewActiveOpd.isAllowed(billingOnly),
          isTrue,
        );
        ...
        // billing:read alone satisfies viewActiveOpd ∪.
        expect(
          PatientBalanceDueAtomPermissions.viewActiveOpd.isAllowed(neither),
          isTrue,
        );
      },
    );
