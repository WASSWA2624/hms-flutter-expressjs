  ...
  group('All patients tab UI authorization (AC2-AC5)', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // Visit is optional on All — not in the default five.
    ...
    testWidgets(
      'active All badge uses filtered total; Active sibling stays overview',
      (WidgetTester tester) async {
        await _pumpAllTab(
          tester,
          patientRepository: patientRepository,
          ...
          return Result<AppPage<Patient>>.success(
            AppPage<Patient>(
              items: narrowed
                  ...
                  : const <Patient>[_idlePatient, _allPatient],
              request: query.pageRequest,
              totalItemCount: narrowed ? 1 : 7,
            ),
          );
        });
