...
void main() {
  test('production frontend workspaces do not render developer backend-gap text', () {
    const paths = <String>[
      'lib/features/pharmacy/presentation/pages/pharmacy_workspace_page.dart',
      'lib/features/physiotherapy/presentation/pages/physiotherapy_workspace_page.dart',
      'lib/features/integrations/presentation/pages/integrations_workspace_page.dart',
      'lib/features/rooms_beds/presentation/pages/rooms_beds_workspace_page.dart',
      'lib/features/housekeeping/presentation/pages/housekeeping_workspace_page.dart',
      'lib/features/discharge/presentation/pages/discharge_workspace_page.dart',
    ];
