...
void main() {
  ...
  group('PhysiotherapyReferralsAtomPermissions helpers', () {
    ...
    test('full ∩ write set presents write atoms', () {
      ...
      expect(
        identical(
          PhysiotherapyReferralsAtomPermissions.updatePlan,
          physiotherapyWorkspaceWriteRequirement,
        ),
        isTrue,
      );
      expect(
        identical(
          PhysiotherapyReferralsAtomPermissions.addProgressNote,
          physiotherapyWorkspaceWriteRequirement,
        ),
        isTrue,
      );
      expect(
        identical(
          PhysiotherapyReferralsAtomPermissions.closeEpisode,
          physiotherapyWorkspaceWriteRequirement,
        ),
        isTrue,
      );
  ...
  group('Physiotherapy Referrals tab UI gates', () {
    ...
    testWidgets(
      'post-mutation sync: Accept referral refreshes after save',
      (WidgetTester tester) async {
        ...
        when(() => repository.listWorkItems(any())).thenAnswer((
          ...
          final PhysiotherapyWorklistQuery query =
              invocation.positionalArguments.single as PhysiotherapyWorklistQuery;
          final List<TherapyWorkItem> filtered = <TherapyWorkItem>[_referralItem]
              .where(
                (TherapyWorkItem item) =>
                    physiotherapyItemMatchesScope(item, query.scope),
              )
