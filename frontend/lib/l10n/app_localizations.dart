...
abstract class AppLocalizations {
  ...
  /// Action label for printing an invoice with the standard template.
  ///
  /// In en, this message translates to:
  /// **'Print invoice'**
  String get billingPrintInvoiceAction;
  ...
  /// Invoice total after adjustments on printed invoices.
  ///
  /// In en, this message translates to:
  /// **'Effective total'**
  String get billingEffectiveTotalLabel;

  /// Gross payments received before refunds on printed invoices.
  ///
  /// In en, this message translates to:
  /// **'Payments received'**
  String get billingGrossPaymentsLabel;

  /// Net paid amount after refunds on printed invoices.
  ///
  /// In en, this message translates to:
  /// **'Net paid'**
  String get billingNetPaidLabel;

  /// Refunded amount on printed invoices.
  ///
  /// In en, this message translates to:
  /// **'Refunds'**
  String get billingRefundsLabel;
  ...
  String get labOfferAtFacilityLabel;

  /// Hint shown when facility lab settings inherit platform defaults.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Offered'**
  String get labOfferedStatusLabel;

  /// Status label when a lab catalog item is not offered at the facility.
  ///
  /// In en, this message translates to:
  /// **'Not offered'**
  String get labNotOfferedStatusLabel;
