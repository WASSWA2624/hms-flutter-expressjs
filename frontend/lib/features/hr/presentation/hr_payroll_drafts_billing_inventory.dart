  ...
  static const List<HrPayrollDraftsFinancialAtom> atoms =
      <HrPayrollDraftsFinancialAtom>[
        ...
        HrPayrollDraftsFinancialAtom(
          ...
          label: 'Next action Review & approve (hr:write ∩ financial:approve)',
          financialClass: HrPayrollDraftsFinancialClass.notBilled,
          auditCode: 'NOT_BILLED',
        ),
        HrPayrollDraftsFinancialAtom(
          id: 'detail_preview',
          label: 'Detail Compensation breakdown / Print payroll',
          financialClass: HrPayrollDraftsFinancialClass.notBilled,
          auditCode: 'NOT_BILLED',
        ),
        HrPayrollDraftsFinancialAtom(
          id: 'detail_process',
          label: 'Detail Approve & notify Finance / Mark paid / Cancel',
          financialClass: HrPayrollDraftsFinancialClass.notBilled,
          auditCode: 'NOT_BILLED',
        ),
        HrPayrollDraftsFinancialAtom(
          id: 'nested_preview_dialog',
          label: 'Embedded compensation breakdown (gross/component)',
          financialClass: HrPayrollDraftsFinancialClass.notBilled,
          auditCode: 'NOT_BILLED',
        ),
        HrPayrollDraftsFinancialAtom(
          id: 'nested_process_dialog',
          label: 'Nested approve dialog (replace items / notes)',
          financialClass: HrPayrollDraftsFinancialClass.notBilled,
          auditCode: 'NOT_BILLED',
        ),
        HrPayrollDraftsFinancialAtom(
