...
abstract final class AccountsStrings {
  ...
  static const String currenciesLabel = 'Currencies & Exchange Rates';
  static const String currenciesTooltip =
      'Currency registry with dated exchange, buy, and sell rates';
  static const String currenciesEmpty = 'No currencies match.';
  static const String currenciesEmptyBody =
      'Try another search or add a currency rate.';
  static const String currenciesSearchHint =
      'Reference, currency code, name, source…';

  static const String currencyReferenceColumn = 'Reference';
  static const String currencyCodeColumn = 'Currency Code';
  static const String currencyNameColumn = 'Currency Name';
  static const String currencySymbolColumn = 'Symbol';
  static const String currencyDecimalPlacesColumn = 'Decimal Places';
  static const String currencyBaseColumn = 'Base Currency';
  static const String currencyRateTypeColumn = 'Rate Type';
  static const String currencyExchangeRateColumn = 'Exchange Rate';
  static const String currencyEffectiveDateColumn = 'Effective Date';
  static const String currencySourceColumn = 'Source';
  static const String currencyBuyRateColumn = 'Buy Rate';
  static const String currencySellRateColumn = 'Sell Rate';
  static const String currencyLastUpdatedAtColumn = 'Last Updated At';
  static const String currencyUpdatedByColumn = 'Updated By';
  static const String currencyStatusColumn = 'Currency Status';
  static const String currencyActionsColumn = 'Actions';

  static const String currencyStatusDraft = 'Draft';
  static const String currencyStatusActive = 'Active';
  static const String currencyStatusInactive = 'Inactive';
  static const String currencyStatusArchived = 'Archived';
  static const String currencyBaseYes = 'Base';
  static const String currencyBaseNo = 'Quoted';
  static const String currencyDateRangeFilterLabel = 'Effective date range';
  static const String currencyNewRecordAction = 'New record';
  static const String currencyBaseFilterLabel = 'Base currency';
  static const String currencyBaseFilterOnly = 'Base only';
  static const String currencyBaseFilterExclude = 'Quoted only';

  static const String currencyRateTypeSpot = 'Spot';
  static const String currencyRateTypeDaily = 'Daily';
  static const String currencyRateTypeMonthly = 'Monthly';
  static const String currencyRateTypeBudget = 'Budget';
  static const String currencyRateTypeContract = 'Contract';

  static const String currencyCreateTitle = 'Add currency rate';
  static const String currencyEditTitle = 'Edit currency rate';
  static const String currencyCloneTitle = 'Clone currency rate';
  static const String currencyDetailTitle = 'Currency rate details';
  static const String currencyCreateAction = 'Add';
  static const String currencySaveAction = 'Save';
  static const String currencyCloneAction = 'Clone';
  static const String currencyViewAction = 'View';
  static const String currencyActivateAction = 'Activate';
  static const String currencyDeactivateAction = 'Deactivate';
  static const String currencyArchiveAction = 'Archive';
  static const String currencyRestoreAction = 'Restore';

  static const String currencySummarySection = 'Summary';
  static const String currencyRelatedSection = 'Related records';
  static const String currencyAttachmentsSection = 'Attachments';
  static const String currencyActivitySection = 'Activity & audit';
  static const String currencyRelatedEmpty = 'No related records.';
  static const String currencyAttachmentsEmpty = 'No attachments.';
  static const String currencyActivityEmpty = 'No recorded activity.';
  static const String currencyActivityCreated = 'Created';
  static const String currencyActivityUpdated = 'Last updated';
  static const String currencyActivityArchived = 'Archived';
  static const String currencyVersionLabel = 'Record version';
  static const String currencyBaseNotice =
      'The base currency is quoted at 1 and cannot be deactivated or archived while it holds the flag.';

  static const String currencyCodeLabel = 'Currency Code';
  static const String currencyNameLabel = 'Currency Name';
  static const String currencySymbolLabel = 'Symbol';
  static const String currencyDecimalPlacesLabel = 'Decimal Places';
  static const String currencyBaseLabel = 'Base Currency';
  static const String currencyRateTypeLabel = 'Rate Type';
  static const String currencyExchangeRateLabel = 'Exchange Rate';
  static const String currencyEffectiveDateLabel = 'Effective Date';
  static const String currencySourceLabel = 'Source';
  static const String currencyBuyRateLabel = 'Buy Rate';
  static const String currencySellRateLabel = 'Sell Rate';
  static const String currencyEntityAndFacilityLabel = 'Entity/Facility';
  static const String currencyNotesLabel = 'Notes';

  static const String currencyRequiredField = 'This field is required.';
  static const String currencyCodeInvalid =
      'Enter a three-letter ISO currency code.';
  static const String currencyDecimalPlacesInvalid =
      'Enter a number of decimal places between 0 and 6.';
  static const String currencyRateInvalid = 'Enter a rate greater than zero.';
  static const String currencyBuyAboveSell =
      'Buy rate must not be higher than the sell rate.';
  static const String currencyBaseRateMustBeOne =
      'The base currency exchange rate must be 1.';

  static const String currencyActivateConfirmTitle = 'Activate currency rate?';
  static const String currencyDeactivateConfirmTitle =
      'Deactivate currency rate?';
  static const String currencyArchiveConfirmTitle = 'Archive currency rate?';
  static const String currencyRestoreConfirmTitle = 'Restore currency rate?';
  static const String currencyArchiveConfirmBody =
      'The rate is archived, not deleted. Historical translations stay available and the record can be restored.';
  static const String currencyBulkActivateAction = 'Activate selected';
  static const String currencyBulkDeactivateAction = 'Deactivate selected';
  static const String currencyBulkArchiveAction = 'Archive selected';

  static String currencyActivateConfirmBody(String reference) =>
      'Activate $reference so permitted workflows can select it?';
  static String currencyDeactivateConfirmBody(String reference) =>
      'Deactivate $reference so it is no longer selectable for new work?';
  static String currencyRestoreConfirmBody(String reference) =>
      'Restore $reference and record the change in the audit trail?';
  static String currencyBulkConfirmBody(int count, String action) =>
      'Apply $action to $count matching currency rate(s)? '
      'Records that do not allow the change are skipped.';
  static String currencyBulkPartialFailure(int failed) =>
      '$failed record(s) could not be changed.';
  static String currencyRowsTotal(int total) => '$total rate(s)';
  static String currencyActiveTotal(int active) => '$active active';
