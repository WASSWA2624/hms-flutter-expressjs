...
class _AccountsGlPanelState extends ConsumerState<AccountsGlPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppListTable<AccountsGlAccount>(
      ...
      exportConfig: AppListTableExportConfig<AccountsGlAccount>(
        fileNameStem: 'accounts_gl',
        dateOf: (AccountsGlAccount item) => item.updatedAt,
        sheetName: AccountsStrings.generalLedgerLabel,
      ...
      search: AppListTableSearch<AccountsGlAccount>(
        ...
        dateFilterLabel: AccountsStrings.updatedDateFilterLabel,
