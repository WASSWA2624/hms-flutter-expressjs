...
class _AccountsLedgersPanelState extends ConsumerState<AccountsLedgersPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppListTable<AccountsPatientBalance>(
      ...
      exportConfig: AppListTableExportConfig<AccountsPatientBalance>(
        fileNameStem: 'accounts_patient_ledgers',
        dateOf: (AccountsPatientBalance item) => item.updatedAt,
        sheetName: AccountsStrings.patientLedgersLabel,
