  ...
  Widget build(BuildContext context) {
    ...
    final Widget table = AppListTable<AccountsFiscalPeriod>(
      ...
      exportConfig: AppListTableExportConfig<AccountsFiscalPeriod>(
        fileNameStem: 'accounts_books',
        dateOf: (AccountsFiscalPeriod item) =>
            item.closedAt ?? item.openedAt ?? item.endDate ?? item.startDate,
        sheetName: AccountsStrings.closeBooksLabel,
